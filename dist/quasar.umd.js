  ...
  var QSelect = Vue.extend({
    ...
    methods: {
      ...
      __onTargetKeydown: function __onTargetKeydown (e) {
        ...
        if (
          ...
          var done = function (val, mode) {
            ...
            this$1.__updateInputValue('', this$1.multiple !== true);
          };
      ...
      __onInputValue: function __onInputValue (e) {
        ...
        // mark it here as user input so that if __updateInputValue is called
      ...
      // signal to the internal method that this is called by user
      updateInputValue: function updateInputValue (val, noFiltering) {
        this.__updateInputValue(val, noFiltering, true);
      },

      __updateInputValue: function __updateInputValue (val, noFiltering, userInput) {
        this.userInputValue = userInput === true;
      ...
      __resetInputValue: function __resetInputValue () {
        this.useInput === true && this.__updateInputValue(
