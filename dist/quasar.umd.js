/*!
 * Quasar Framework v1.4.1-test.2
...
(function (global, factory) {
  ...
  function cloneTouchEvent (evt) {
    ...
    var cloned = new TouchEvent(evt.type, {
      bubbles: evt.bubbles,
      cancelable: evt.cancelable,
      composed: evt.composed,
    ...
    methods: {
      ...
      __onTouchstart: function __onTouchstart (e) {
        if (touchTarget !== this.$el) {
          ...
          var target = this.$q.platform.is.ios === true && this.$q.platform.is.iosEmulated !== true ? document : touchTarget;
      ...
      __unconfigureAnchorEl: function __unconfigureAnchorEl (context) {
        ...
        if (context === true) {
          if (this.$q.platform.is.mobile === true) {
            ...
            var target = this.$q.platform.is.ios === true && this.$q.platform.is.iosEmulated !== true ? document : this.anchorEl
            ;['touchcancel', 'touchmove', 'touchend'].forEach(function (evt) {
              target.removeEventListener(evt, this$1.__mobileCleanup, passive);
            });
          }
          else {
      ...
      __configureAnchorEl: function __configureAnchorEl (context) {
        ...
        if (context === true) {
          if (this.$q.platform.is.mobile === true) {
            ...
            var target = this.$q.platform.is.ios === true && this.$q.platform.is.iosEmulated ? document : this.anchorEl
            ;['touchcancel', 'touchmove', 'touchend'].forEach(function (evt) {
              target.addEventListener(evt, this$1.__mobileCleanup, passive);
            });
          }
          else {
    ...
    created: function created () {
      ...
      if (
        ...
        this.noParentEventWatcher = this.$watch('noParentEvent', function () {
          if (this$1.computedScrollTarget !== void 0) {
  ...
  function getScrollTargetEnhanced (scrollTarget, fallback) {
    var __scrollTarget = typeof scrollTarget === 'string' ? document.querySelector(scrollTarget) : scrollTarget;
    ...
    methods: {
      ...
      __unconfigureScrollTarget: function __unconfigureScrollTarget () {
        if (this.computedScrollTarget !== void 0) {
          this.computedScrollTarget.removeEventListener('scroll', this.updatePosition, listenOpts.passive);
      ...
      __configureScrollTarget: function __configureScrollTarget () {
        if (this.anchorEl !== void 0 || this.scrollTarget !== void 0) {
          ...
          this.computedScrollTarget.addEventListener('scroll', this.updatePosition, listenOpts.passive);
    ...
    bind: function bind (el, ref) {
      ...
      var ctx = {
        ...
        touchStart: function touchStart (evt) {
          var target = client.is.ios === true && client.is.iosEmulated !== true ? document : evt.target;
  ...
  var PanelParentMixin = {
    ...
    computed: {
      ...
      evtDirectionNext: function evtDirectionNext () {
  ...
  var QCarousel = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        }, obj[("q-carousel--arrows" + (this.arrowsVertical === true ? '--vertical' : ''))] = this.padding === true && this.arrows === true, obj['q-carousel--navigation'] = this.padding === true && this.navigation === true, obj['q-carousel--dark q-dark'] = this.isDark, obj )
      },
      ...
      var ctx = {
        ...
        start: function start (evt, mouseEvent) {
          ...
          if (
            ...
            var clone = evt.type === 'mousedown' ? cloneMouseEvent(evt) : cloneTouchEvent(evt);
        ...
        move: function move (evt) {
          ...
          if (ctx.direction.all === true) {
            ...
            ctx.move(evt);
            ctx.event.mouse === true && document.addEventListener('click', stopAndPrevent, notPassiveCapture$2);
            return
          }
    ...
    methods: {
      ...
      __unconfigureAnchorEl: function __unconfigureAnchorEl () {
        ...
        if (this.$q.platform.is.mobile === true) {
          ...
          ;['touchcancel', 'touchmove', 'click'].forEach(function (evt) {
            target.removeEventListener(evt, this$1.__delayHide, passive$1);
          });
        }
        else {
      ...
      __configureAnchorEl: function __configureAnchorEl () {
        ...
        if (this.$q.platform.is.mobile) {
          ...
          var target = this.$q.platform.is.ios === true && this.$q.platform.is.iosEmulated !== true ? document : this.anchorEl
          ;['touchcancel', 'touchmove', 'click'].forEach(function (evt) {
            target.addEventListener(evt, this$1.__delayHide, passive$1);
          });
        }
        else {
      ...
      __unconfigureScrollTarget: function __unconfigureScrollTarget () {
        if (this.computedScrollTarget !== void 0) {
          this.computedScrollTarget.removeEventListener('scroll', this.hide, passive$1);
          this.computedScrollTarget = void 0;
        }
      ...
      __configureScrollTarget: function __configureScrollTarget () {
        if (this.anchorEl !== void 0 || this.scrollTarget !== void 0) {
          ...
          if (this.noParentEvent !== true) {
            this.computedScrollTarget.addEventListener('scroll', this.hide, passive$1);
          }
          if (this.noParentEvent === true || this.computedScrollTarget !== window) {
    ...
    methods: {
      ...
      __onClick: function __onClick (e) {
        if (this.isClickable === true) {
          if (this.noRefocus !== true && e.qKeyEvent !== true && this.$refs.blurTarget !== void 0) {
            this.$refs.blurTarget.focus();
          }
