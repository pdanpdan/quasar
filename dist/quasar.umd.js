...
(function (global, factory) {
  ...
  */
  ...
  var alignValues$2 = Object.keys(alignMapping);
  ...
  var QSelect = Vue.extend({
    ...
    computed: {
      ...
      optionValueKey: function optionValueKey () {
    ...
    methods: {
      ...
      __getControl: function __getControl (h, fromDialog) {
        ...
        if (this.disable !== true && this.innerValue.length > 0) {
          var options = this.innerValue
            .filter(function (value) { return Object(value) !== value; })
            .map(function (value) { return h('option', {
              domProps: {
                value: value,
                selected: true
              }
    ...
    methods: {
      add: function add (config) {
        ...
        if (notif.group !== void 0) {
          var mainNotif = this.notifs[notif.position].find(function (n) { return n.group === notif.group; });
      ...
      remove: function remove (notif) {
        ...
        if (notif.groupContent !== void 0) {
          notif.groupContent.slice(1).forEach(function (fn) { return fn(); });
        }
        else if (notif.group !== void 0) {
          var index$1 = this.notifs[notif.position].findIndex(function (n) { return n.group === notif.group; });

          if (index$1 !== -1) {
            var mainNotif = this.notifs[notif.position][index$1];
            ...
            if (mainNotif.groupContent.length === 1) {
              ...
              this.notifs[notif.position].splice(index$1, 1, mainNotif);
            }
      ...
      return h('div', { staticClass: 'q-notifications' }, positionList.map(function (pos) {
        ...
        return h('transition-group', {
          ...
          if (notif.badge !== false) {
            var groupCount = Array.isArray(notif.groupContent) === true
            ...
            if (groupCount > 1) {
              child.push(
                h(QBadge, {
                  ...
                  props: Object.assign({}, {transparent: true},
                    notif.badgeProps,
                    {floating: false,
                    label: groupCount})
                })
