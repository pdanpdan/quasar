/*!
 * Quasar Framework v1.0.5-test.1
  ...
  */
  ...
  var VirtualList = {
    ...
    methods: {
      __hydrateVirtualList: function __hydrateVirtualList (ev, toIndex) {
          ...
          if (toIndex !== void 0) {
            this.$nextTick(function () {
              var
                ...
                scroll = target[this$1.__sizeKeys.scroll],
                viewSize = target[this$1.__sizeKeys.clientSize],
                childPosStart = child === void 0 ? -1 : content[this$1.__sizeKeys.offset] + child[this$1.__sizeKeys.offset],
                childPosSize = child === void 0 ? this$1.virtualListItemDefaultSize : child[this$1.__sizeKeys.clientSize],
        ...
        if (fromScroll === true) {
          ...
          if (this.virtualListSizes !== null) {
            ...
            for (var i = Math.trunc(scroll + viewSize / 2); i >= 0 && toIndex < toIndexMax;) {
              toIndex++;
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, target, fromScroll) {
        var this$1 = this;
        ...
        this.$nextTick(function () {
          ...
          for (var i = children.length - 1; i >= 0; i--) {
            var diff = children[i][this$1.__sizeKeys.clientSize] - this$1.virtualListSizes[from + i];
          ...
          if (this$1.virtualListMargin !== margin || this$1.virtualListSize !== size) {
            ...
            content.previousSibling.style.cssText = padding >= 0
              ? ((this$1.__sizeKeys.size) + ": " + padding + "px; " + (this$1.__sizeKeys.marginCSS) + ": 0px")
              : ((this$1.__sizeKeys.size) + ": 0px; " + (this$1.__sizeKeys.marginCSS) + ": " + padding + "px");
            content.style[this$1.__sizeKeys.margin] = "-" + margin + "px";
          }

          if (repositionScroll === true) {
            if (fromScroll !== true) {
              this$1.__setPreventNextScroll(fromScroll);
              target[this$1.__sizeKeys.scroll] = this$1.virtualListSizes.slice(0, toIndex).reduce(function (acc, h) { return acc + h; }, 0);
            }
            else if (marginDiff !== 0) {
              this$1.__setPreventNextScroll(fromScroll);
              target[this$1.__sizeKeys.scroll] += marginDiff;
            }
          }
        });
      },
      ...
      __padVirtualList: function __padVirtualList (h, content, useBg) {
        ...
        for (var i = Math.trunc(this.virtualListSize / this.virtualListMaxPadding); i > 0; i--) {
          list.push(h('div', { staticClass: staticClass, style: ( obj = {}, obj[this.__sizeKeys.size] = ((this.virtualListMaxPadding) + "px"), obj ) }));
        }
        list.push(h('div', { staticClass: staticClass, style: ( obj$1 = {}, obj$1[this.__sizeKeys.size] = ((this.virtualListSize % this.virtualListMaxPadding) + "px"), obj$1 ) }));

        list.push(h('div', {
          staticClass: 'q-virtual-list__content',
          style: ( obj$2 = {}, obj$2[this.__sizeKeys.margin] = ("-" + (this.virtualListMargin) + "px"), obj$2 )
        }, content));
  ...
  var QVirtualList = Vue.extend({
      ...
      optionScope: function optionScope () {
        ...
        return this.virtualListSlice.map(function (opt, i) {
          ...
          return {
            index: index,
            opt: opt,
            sanitize: this$1.sanitize === true || opt.sanitize === true,
            itemProps: itemProps
          }
        })
      }
    ...
    methods: {
      ...
      __getOptions: function __getOptions (h) {
        ...
        var fn = this.$scopedSlots.default !== void 0
          ? this.$scopedSlots.default
          : function (scope) {
            var obj;
