/*!
 * Quasar Framework v1.0.0-beta.13.2
...
(function (global, factory) {
  ...
  var QMenu = Vue.extend({
    ...
    methods: {
      __show: function __show (evt) {
        ...
        if (this.observeAnchor === true) {
          this.touchTargetObserver = new MutationObserver(function () {
            this$1.updatePosition(evt);
          });
          this.touchTargetObserver.observe(this.anchorEl, { childList: true, subtree: true });
        }
        ...
        this.timer = setTimeout(function () {
          ...
          this$1.$el.dispatchEvent(new Event('popup-show', { bubbles: true }));
  ...
  */
    ...
    computed: {
      ...
      directives: function directives () {
        ...
        if (this.showBackdrop === true) {
          directives.push({
            name: 'click-outside',
            value: this.persistent !== true && this.noBackdropDismiss !== true
              ? this.hide
              : this.shake,
            arg: this.__portal !== void 0 ? this.__portal.$refs : []
          });
        }
    ...
    methods: {
      ...
      __hide: function __hide (evt) {
        ...
        this.timer = setTimeout(function () {
          ...
          this$1.$el.dispatchEvent(new Event('popup-hide', { bubbles: true }));
  ...
  var QField = Vue.extend({
    ...
    methods: {
      ...
      __onControlFocusin: function __onControlFocusin (e) {
        ...
        var target = this.$refs.target || this.$refs.input;
      ...
      __onControlFocusout: function __onControlFocusout (e) {
        ...
        setTimeout(function () {
          if (document.hasFocus() === true) {
            if (this$1.keepFocus === true || this$1.$refs === void 0 || this$1.$refs.control === void 0) {
              return
            }
  ...
  var QExpansionItem = Vue.extend({
    ...
    methods: {
      __toggleItemKeyboard: function __toggleItemKeyboard (e) {
      ...
      __getToggleIcon: function __getToggleIcon (h) {
        var isActive = this.disable !== true && (this.hasRouterLink === true || this.expandIconToggle === true);
  ...
  var QSelect = Vue.extend({
    ...
    methods: {
      ...
      __getMenuRef: function __getMenuRef () {
        if (this.$refs.menu !== void 0 && this.$refs.menu.__portal !== void 0) {
          return this.$refs.menu.__portal.$el
        }
      },

      __onTargetFocusin: function __onTargetFocusin (e) {
        if (e.target !== this.$refs.target) { // move to a chip from list
          this.menu = false;
          this.__updateLocalMenu();
        }
      },

      __onTargetFocusout: function __onTargetFocusout (e) {
        if (e.relatedTarget !== this.$refs.control) { // move to a chip from input
          this.menu = false;
          this.__updateLocalMenu();
        }
      },
      ...
      __onGlobalKeydown: function __onGlobalKeydown (e) {
        ...
        if (e.keyCode === 38 || e.keyCode === 40) {
          ...
          if (this.menu === true) {
            ...
            this.$nextTick(function () {
              var
                menu = this$1.__getMenuRef(),
                el = menu === void 0 ? null : menu.querySelector('.q-manual-focusable--focused');
      ...
      __hydrateOptions: function __hydrateOptions () {
        ...
        var menu = this.__getMenuRef();
        if (
          this.avoidScroll !== true &&
          this.optionsToShow < this.options.length &&
          menu !== void 0 &&
          menu.scrollHeight - menu.scrollTop - menu.clientHeight < 200
        ) {
      ...
      __setMenuStatus: function __setMenuStatus (val) {
        this.menu = val;
      },
      ...
      __getLocalMenu: function __getLocalMenu (h) {
        ...
        var mode = this.optionsCover === true && this.noOptions !== true && this.useInput !== true ? 'cover' : 'fit';
        ...
        return h(QMenu, {
          ...
          }, obj[ mode ] = true, obj.autoClose = this.multiple !== true, obj.noFocus = true, obj.noParentEvent = true, obj.observeAnchor = true, obj.contentClass = {
              'q-select__menu': true,
      ...
      __getInput: function __getInput (h) {
        return h('input', {
          ...
          on: {
            ...
            keydown: this.__onTargetKeydown,
            focusout: this.__onTargetFocusout
          }
        })
      },
      ...
      __onControlFocusout: function __onControlFocusout (e) {
        ...
        setTimeout(function () {
          ...
          this$1.__onFilterAbort();
        });
      },

      __onFilterAbort: function __onFilterAbort () {
