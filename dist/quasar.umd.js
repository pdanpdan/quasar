/*!
 * Quasar Framework v1.5.4-test.1
  ...
  */
  ...
  var QField = Vue.extend({
    ...
    computed: {
      ...
      getTargetUid: function getTargetUid () {
        var id = this.for === void 0 ? this.targetUid : this.for;
