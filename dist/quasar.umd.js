/*!
 * Quasar Framework v1.0.5-test.9
  ...
  */
  ...
  var QSelect = Vue.extend({
    ...
    computed: {
      ...
      shouldRefocus: function shouldRefocus () {
        // do not refocus input field on Android
        // because it can use all available screen
        // to extend the list of options
        return this.hasDialog !== true || this.useInput !== true || this.$q.platform.is.android !== true
      }
    },
    ...
    methods: {
      ...
      __removeAtIndexAndFocus: function __removeAtIndexAndFocus (index) {
        ...
        this.shouldRefocus === true && this.__focus();
      },
      ...
      __getDialog: function __getDialog (h) {
        ...
        return h(QDialog, {
          ...
          on: {
            ...
            show: function () {
              this$1.$refs.target !== document.activeElement && this$1.$refs.target.focus();
            }
          }
        }, [
          h('div', {
