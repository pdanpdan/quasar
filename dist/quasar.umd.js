/*!
 * Quasar Framework v1.5.2-test.2
  ...
  var Screen = {
    ...
    install: function install ($q, queues) {
      ...
      var update = function (force) {
        ...
        if (s !== this$1.name) {
          this$1.name = s;
          document.body.classList.remove(("screen--" + (this$1.__oldName)));
  ...
  var QCarousel = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        }, obj[("q-carousel--arrows" + (this.arrowsVertical === true ? '--vertical' : ''))] = this.padding === true && this.arrows === true, obj[("q-carousel--navigation--" + (this.navigationPosition))] = this.padding === true && this.navigation === true, obj['q-carousel--dark q-dark'] = this.isDark, obj )
      },
  ...
  */
  ...
  var QDate = Vue.extend({
    ...
    computed: {
      ...
      contentPanelDirectives: function contentPanelDirectives () {
        return [{
          name: 'touch-swipe',
    ...
    methods: {
      ...
      __contentPanelSwipe: function __contentPanelSwipe (evt) {
        var direction = (evt.direction === 'left') === (this.$q.lang.rtl !== true) ? 1 : -1;
  ...
  var QTooltip = Vue.extend({
    ...
    methods: {
      ...
      __unconfigureScrollTarget: function __unconfigureScrollTarget () {
        if (this.computedScrollTarget !== void 0) {
          this.computedScrollTarget.removeEventListener('scroll', this.hide, passive);
          this.computedScrollTarget = void 0;
        }
      ...
      __configureScrollTarget: function __configureScrollTarget () {
        if (this.anchorEl !== void 0 || this.scrollTarget !== void 0) {
          ...
          if (this.noParentEvent !== true) {
            this.computedScrollTarget.addEventListener('scroll', this.hide, passive);
          }
    ...
    methods: {
      __isVisible: function __isVisible (val) {
        return this.scrollReverse === true
          ? this.layout.height - val > this.scrollOffset
          : val > this.scrollOffset
      },
  ...
  var QSelect = Vue.extend({
    ...
    watch: {
      innerValue: {
        handler: function handler (innerValue) {
          if (
            this.useInput === true &&
            this.fillInput === true &&
            this.multiple !== true &&
        ...
        return this.mapOptions === true && Array.isArray(this.options) === true
          ? (
            this.value === null && mapNull === true
              ? val.map(function (v) { return this$1.__getOption(v, innerValueCache); }).filter(function (v) { return v !== null; })
              : val.map(function (v) { return this$1.__getOption(v, innerValueCache); })
          )
          : val
      },
    ...
    methods: {
      ...
      __getOption: function __getOption (value, innerValueCache) {
        ...
        return this.options.find(function (opt) { return isDeepEqual(this$1.__getOptionValue(opt), value); }) ||
          innerValueCache.find(function (opt) { return isDeepEqual(this$1.__getOptionValue(opt), value); }) ||
          value
      },
