/*!
 * Quasar Framework v1.0.5-test.8
...
(function (global, factory) {
  ...
  */
  ...
  var VirtualList = {
    ...
    watch: {
      virtualListOptionsLength: function virtualListOptionsLength (virtualListLength) {
    ...
    methods: {
      __hydrateVirtualList: function __hydrateVirtualList (ev, toIndex, toTop) {
        var this$1 = this;
        ...
        if (content === null) {
          this.virtualListHidrateTimer = setTimeout(function () {
            this$1.__hydrateVirtualList({ target: this$1.__getVirtualListEl() }, toIndex, toTop);
          }, 10);
      ...
      __setVirtualListSize: function __setVirtualListSize (virtualListLength, reset) {
