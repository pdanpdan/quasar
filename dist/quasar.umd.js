/*!
 * Quasar Framework v1.0.5-test.19
...
(function (global, factory) {
  ...
  var QBtn = Vue.extend({
    ...
    methods: {
      ...
      __onPressEnd: function __onPressEnd () {
  ...
  var ClickOutside = {
    ...
    bind: function bind (el, ref, vnode) {
      ...
      if (handlers.click.length === 0) {
        ...
        Platform.is.desktop === true && document.addEventListener('focusin', globalHandler, passiveCapture$1);
      }
    ...
    unbind: function unbind (el) {
      ...
      if (ctx !== void 0) {
        ...
        if (handlers.click.length === 0) {
          ...
          Platform.is.desktop === true && document.removeEventListener('focusin', globalHandler, passiveCapture$1);
        }
  ...
  var TouchSwipe = {
    ...
    bind: function bind (el, ref) {
      ...
      var mouseEvtOpts = listenOpts[("notPassive" + (modifiers.mouseCapture === true ? 'Capture' : ''))];
      ...
      var ctx = {
        ...
        mouseStart: function mouseStart (evt) {
          if (ctx.event === void 0 && leftClick(evt)) {
            ...
            document.addEventListener('mouseup', ctx.mouseEnd, notPassiveCapture$1);
            ctx.start(evt, true);
          }
        },
        ...
        mouseEnd: function mouseEnd (evt) {
          ...
          document.removeEventListener('mouseup', ctx.mouseEnd, notPassiveCapture$1);
          ctx.end(evt);
        },
        ...
        touchStart: function touchStart (evt) {
          ...
          if (ctx.event === void 0 && touchTarget !== void 0) {
            ...
            touchTarget.addEventListener('touchcancel', ctx.touchEnd, notPassiveCapture$1);
            touchTarget.addEventListener('touchend', ctx.touchEnd, notPassiveCapture$1);
            ctx.start(evt);
          }
        },

        touchEnd: function touchEnd (evt) {
          var touchTarget = ctx.touchTarget;
          if (touchTarget !== void 0) {
            touchTarget.removeEventListener('touchcancel', ctx.touchEnd, notPassiveCapture$1);
            touchTarget.removeEventListener('touchend', ctx.touchEnd, notPassiveCapture$1);
          }
          ctx.end(evt);
        },
    ...
    unbind: function unbind (el, ref) {
      ...
      if (ctx !== void 0) {
        var mouseEvtOpts = listenOpts[("passive" + (modifiers.mouseCapture === true ? 'Capture' : ''))];
        ...
        if (ctx.event !== void 0) {
          ...
          if (ctx.event.mouse === true) {
            ...
            var target = ctx.touchTarget;
            if (target !== void 0) {
              target.removeEventListener('touchcancel', ctx.touchEnd, notPassiveCapture$1);
              target.removeEventListener('touchend', ctx.touchEnd, notPassiveCapture$1);
            }
          }
        }
      ...
      var ctx = {
        ...
        mouseStart: function mouseStart (evt) {
          if (ctx.event === void 0 && leftClick(evt)) {
            ...
            document.addEventListener('mousemove', ctx.move, mouseEvtOpts);
            document.addEventListener('mouseup', ctx.mouseEnd, notPassiveCapture$2);
            ctx.start(evt, true);
          }
        },
        ...
        mouseEnd: function mouseEnd (evt) {
          document.removeEventListener('mousemove', ctx.move, mouseEvtOpts);
          document.removeEventListener('mouseup', ctx.mouseEnd, notPassiveCapture$2);
          ctx.end(evt);
        },
        ...
        touchStart: function touchStart (evt) {
          ...
          if (ctx.event === void 0 && touchTarget !== void 0) {
            ctx.touchTarget = touchTarget;
            touchTarget.addEventListener('touchcancel', ctx.touchEnd, notPassiveCapture$2);
            touchTarget.addEventListener('touchend', ctx.touchEnd, notPassiveCapture$2);
            ctx.start(evt);
          }
        },
        ...
        touchEnd: function touchEnd (evt) {
          var touchTarget = ctx.touchTarget;
          if (touchTarget !== void 0) {
            touchTarget.removeEventListener('touchcancel', ctx.touchEnd, notPassiveCapture$2);
            touchTarget.removeEventListener('touchend', ctx.touchEnd, notPassiveCapture$2);
          }
          ctx.end(evt);
        },
        ...
        move: function move (evt) {
          ...
          if (ctx.event.isFirst === true) {
            var fn = (modifiers.mouse === true && ctx.event.mouse === true) || (modifiers.stop === true && modifiers.prevent === true)
              ? stopAndPrevent
              : (modifiers.stop === true
                ? stop
                : (modifiers.prevent === true ? prevent : void 0)
              );
            fn !== void 0 && document.addEventListener('click', fn, notPassiveCapture$2);
          ...
          if (ctx.event.detected === true) {
            ...
            fn !== void 0 && setTimeout(function () {
              document.removeEventListener('click', fn, notPassiveCapture$2);
            }, 50);
      ...
      if (ctx !== void 0) {
        ...
        if (ctx.event !== void 0) {
          ...
          if (ctx.event.detected === true) {
            ...
            fn !== void 0 && document.removeEventListener('click', fn, notPassiveCapture$2);
  ...
  */
  ...
  var QEditor = Vue.extend({
    ...
    watch: {
      ...
      activeState: function activeState (state) {
        var this$1 = this;

        setTimeout(function () {
          if (state === this$1.activeState && state !== this$1.lastState) {
            this$1.$emit(state === true ? 'editor-focus' : 'editor-blur');
    ...
    methods: {
      ...
      __setActiveState: function __setActiveState () {
        if (this.activeState !== true) {
          this.activeState = true;
        }
      },

      __setInactiveState: function __setInactiveState () {
  ...
  function sumSize (sizeAgg, size, from, to) {
    ...
    if (fromAgg === toAgg) {
      ...
      return size.slice(from, to).reduce(function (acc, h) { return acc + h; }, 0)
    }
    ...
    var
      ...
      after = to % aggBucketSize === 0 ? 0 : size
        .slice(toAgg * aggBucketSize, to)
        .reduce(function (acc, h) { return acc + h; }, 0),
      total = sizeAgg
        .slice(fromAgg, toAgg)
        .reduce(function (acc, h) { return acc + h; }, before + after);
  ...
  var VirtualList = {
    ...
    watch: {
      virtualListHorizontal: function virtualListHorizontal () {
        this.__setVirtualListSize();
      }
    },

    methods: {
      scrollTo: function scrollTo (toIndex, scrollTowardsEnd) {
        var this$1 = this;

        clearTimeout(this.__preventNextScroll);
        this.__preventNextScroll = setTimeout(function () {
          this$1.__preventNextScroll = void 0;
        }, 500);
      ...
      __onVirtualListScroll: function __onVirtualListScroll () {
        var scrollEl = this.__getVirtualListScrollTarget();
        ...
        var ref = getScrollDetails(scrollEl, this.__getVirtualListEl(), this.virtualListHorizontal);
        var scrollStart = ref.scrollStart;
        var scrollViewSize = ref.scrollViewSize;
        var offsetStart = ref.offsetStart;

        var listLastIndex = this.virtualListLength - 1;

        var
          toIndex = -1,
          listOffset = Math.max(0, scrollStart - offsetStart + Math.floor(scrollViewSize / 2));

        for (var j = 0; listOffset >= this.virtualListSizesAgg[j] && toIndex < listLastIndex; j++) {
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, align) {
        var this$1 = this;
        ...
        var ref = getScrollDetails(scrollEl, void 0, this.virtualListHorizontal);
        var scrollStart = ref.scrollStart;
        ...
        if (from !== prevFrom || to !== prevTo) {
          this.virtualListSliceRange = { from: from, to: to };
        }
        ...
        this.$nextTick(function () {
          ...
          if (from !== prevFrom || to !== prevTo) {
            var
              contentEl = this$1.$refs.content,
              beforeEl = this$1.$refs.before,
              afterEl = this$1.$refs.after,
              paddingSize = this$1.virtualListHorizontal === true ? 'width' : 'height';
            ...
            if (contentEl !== void 0) {
              ...
              for (var i = children.length - 1; i >= 0; i--) {
                var
                  index = from + i,
                  diff = children[i][this$1.virtualListHorizontal === true ? 'offsetWidth' : 'offsetHeight'] - this$1.virtualListSizes[index];

                if (diff !== 0) {
                  if (index < prevFrom) {
                    scrollDiff += diff;
                  }
                  this$1.virtualListSizes[index] += diff;
                  this$1.virtualListSizesAgg[Math.floor(index / aggBucketSize)] += diff;
                }
              }
            }

            this$1.virtualListPaddingBefore = sumSize(this$1.virtualListSizesAgg, this$1.virtualListSizes, 0, from);
            this$1.virtualListPaddingAfter = sumSize(this$1.virtualListSizesAgg, this$1.virtualListSizes, to, this$1.virtualListLength);

            beforeEl !== void 0 && (beforeEl.style[paddingSize] = (this$1.virtualListPaddingBefore) + "px");
            afterEl !== void 0 && (afterEl.style[paddingSize] = (this$1.virtualListPaddingAfter) + "px");
          }

          if (from !== prevFrom || to !== prevTo || align !== void 0) {
            var
              posStart = this$1.virtualListSizes.slice(from, toIndex).reduce(function (acc, h) { return acc + h; }, this$1.virtualListPaddingBefore),
              posEnd = posStart + this$1.virtualListSizes[toIndex],
              posOriginal = scrollDiff + scrollStart;

            this$1.__setVirtualListScroll(posOriginal, posStart, posEnd, align);

            if (from > prevTo && this$1.virtualListScrollApple !== true) {
              this$1.__onVirtualListScroll();
            }
          }
        });
      },

      __setVirtualListScroll: function __setVirtualListScroll (scrollStart, posStart, posEnd, align) {
        var scrollEl = this.__getVirtualListScrollTarget();
        ...
        var keepScroll = align === void 0 || (scrollStart < posStart && posEnd < scrollStart + scrollViewSize);

        if (keepScroll !== true || this.virtualListScrollApple !== true) {
          setScroll$1(
            scrollEl,
      ...
      __resetVirtualList: function __resetVirtualList (toIndex) {
        var this$1 = this;

        var defaultSize = this.virtualListItemDefaultSize;

        if (Array.isArray(this.virtualListSizes) === false) {
          this.virtualListSizes = [];
        }

        var oldVirtualListSizesLength = this.virtualListSizes.length;

        this.virtualListSizes.length = this.virtualListLength;

        for (var i = this.virtualListLength - 1; i >= oldVirtualListSizesLength; i--) {
          this.virtualListSizes[i] = defaultSize;
        }

        var jMax = Math.floor((this.virtualListLength - 1) / aggBucketSize);
        this.virtualListSizesAgg = [];
        for (var j = 0; j <= jMax; j++) {
          var size = 0;
          var iMax = Math.min((j + 1) * aggBucketSize, this.virtualListLength);
          for (var i$1 = j * aggBucketSize; i$1 < iMax; i$1++) {
            size += this.virtualListSizes[i$1];
          }
      ...
      __setVirtualListSize: function __setVirtualListSize () {
      ...
      __padVirtualList: function __padVirtualList (h, content) {
        var obj, obj$1;
        ...
        list.push(h('div', {
          ...
          ref: 'before',
          style: ( obj = {}, obj[paddingSize] = ((this.virtualListPaddingBefore) + "px"), obj )
        }));
        ...
        list.push(h('div', {
          staticClass: 'q-virtual-list__padding',
          ref: 'after',
          style: ( obj$1 = {}, obj$1[paddingSize] = ((this.virtualListPaddingAfter) + "px"), obj$1 )
        }));
    ...
    beforeMount: function beforeMount () {
      this.virtualListScrollApple = this.$q.platform.is.ios === true || this.$q.platform.is.safari === true;

      this.__onVirtualListScroll = this.virtualListScrollApple === true
  ...
  var QSelect = Vue.extend({
    ...
    computed: {
      virtualListLength: function virtualListLength () {
      ...
      optionScope: function optionScope () {
        ...
        var ref = this.virtualListSliceRange;
        var from = ref.from;
        var to = ref.to;
    ...
    methods: {
      ...
      setOptionIndex: function setOptionIndex (index) {
        ...
        var val = index > -1 && index < this.virtualListLength
          ? index
          : -1;
      ...
      __onTargetKeydown: function __onTargetKeydown (e) {
        ...
        // up, down
        var optionsLength = this.virtualListLength;
      ...
      __getVirtualListEl: function __getVirtualListEl () {
      ...
      __getVirtualListScrollTarget: function __getVirtualListScrollTarget () {
  ...
  var QUploaderBase = {
    ...
    methods: {
      ...
      __onIEPickFiles: function __onIEPickFiles (e) {
        if (this.editable) {
          var input = this.__getFileInput();
  ...
  var QVirtualList = Vue.extend({
    ...
    computed: {
      ...
      virtualListScope: function virtualListScope () {
        var this$1 = this;
        ...
        var mapFn = function (item, i) { return ({
          index: this$1.virtualListSliceRange.from + i,
          item: item
        }); };
  ...
  var passiveCapture$2 = listenOpts.passiveCapture;
  var notPassiveCapture$3 = listenOpts.notPassiveCapture;
  ...
  var TouchHold = {
      ...
      var ctx = {
        mouseStart: function mouseStart (evt) {
          ...
          if (ctx.eventStarter === void 0 && leftClick(evt)) {
            ...
            document.addEventListener('mouseup', ctx.mouseEnd, passiveCapture$2);
            ctx.start(evt, true);
          }
        },
        ...
        mouseEnd: function mouseEnd (evt) {
          ...
          document.removeEventListener('mouseup', ctx.mouseEnd, passiveCapture$2);
          ctx.end(evt);
        },
        ...
        touchStart: function touchStart (evt) {
          ...
          if (ctx.eventStarter === void 0 && touchTarget !== void 0) {
            ...
            touchTarget.addEventListener('touchcancel', ctx.touchEnd, passiveCapture$2);
            touchTarget.addEventListener('touchend', ctx.touchEnd, passiveCapture$2);
            ctx.start(evt);
          }
        },
        ...
        touchEnd: function touchEnd (evt) {
          ...
          if (touchTarget !== void 0) {
            ...
            touchTarget.removeEventListener('touchcancel', ctx.touchEnd, passiveCapture$2);
            touchTarget.removeEventListener('touchend', ctx.touchEnd, passiveCapture$2);
          }
          ctx.end(evt);
        },
        ...
        start: function start (evt, mouseEvent) {
          ...
          ctx.timer = setTimeout(function () {
            ...
            document.addEventListener('click', stopAndPrevent, notPassiveCapture$3);
            ctx.eventStarter === 'touch' && document.addEventListener('contextmenu', stopAndPrevent, notPassiveCapture$3);
          ...
          var eventStarter = ctx.eventStarter;

          eventStarter === 'touch' && document.body.classList.remove('non-selectable');

          if (ctx.triggered === true) {
            setTimeout(function () {
              document.removeEventListener('click', stopAndPrevent, notPassiveCapture$3);
              eventStarter === 'touch' && document.removeEventListener('contextmenu', stopAndPrevent, notPassiveCapture$3);
            }, 50);
          }
          else {
            clearTimeout(ctx.timer);
    ...
    unbind: function unbind (el, ref) {
      ...
      if (ctx !== void 0) {
        ...
        if (ctx.triggered === true) {
          document.removeEventListener('click', stopAndPrevent, notPassiveCapture$3);
          ctx.eventStarter === 'touch' && document.removeEventListener('contextmenu', stopAndPrevent, notPassiveCapture$3);
        }
  ...
  var passiveCapture$3 = listenOpts.passiveCapture;
  var notPassiveCapture$4 = listenOpts.notPassiveCapture;
  ...
  var TouchRepeat = {
    ...
    bind: function bind (el, ref) {
      ...
      var ctx = {
        ...
        mouseStart: function mouseStart (evt) {
          ...
          if (ctx.eventStarter === void 0 && leftClick(evt)) {
            document.addEventListener('mousemove', ctx.move, mouseEvtOpts);
            document.addEventListener('mouseup', ctx.mouseEnd, passiveCapture$3);
            ctx.start(evt, true);
          }
        },
        ...
        mouseEnd: function mouseEnd (evt) {
          document.removeEventListener('mousemove', ctx.move, mouseEvtOpts);
          document.removeEventListener('mouseup', ctx.mouseEnd, passiveCapture$3);
          ctx.end(evt);
        },
        ...
        touchStart: function touchStart (evt) {
          ...
          if (ctx.eventStarter === void 0 && touchTarget !== void 0) {
            ...
            touchTarget.addEventListener('touchcancel', ctx.touchEnd, passiveCapture$3);
            touchTarget.addEventListener('touchend', ctx.touchEnd, passiveCapture$3);
            ctx.start(evt);
          }
        },
        ...
        touchEnd: function touchEnd (evt) {
          ...
          if (touchTarget !== void 0) {
            ...
            touchTarget.removeEventListener('touchcancel', ctx.touchEnd, passiveCapture$3);
            touchTarget.removeEventListener('touchend', ctx.touchEnd, passiveCapture$3);
          }
          ctx.end(evt);
        },
        ...
        keyboardStart: function keyboardStart (evt) {
          if (ctx.eventStarter === void 0 && keyboard.includes(evt.keyCode)) {
            el.focus();
            el.addEventListener('blur', ctx.keyboardEnd, passiveCapture$3);
            document.addEventListener('keyup', ctx.keyboardEnd, passiveCapture$3);
            ctx.start(evt, false, true);
          }
        },

        keyboardEnd: function keyboardEnd (evt) {
          el.removeEventListener('blur', ctx.keyboardEnd, passiveCapture$3);
          document.removeEventListener('keyup', ctx.keyboardEnd, passiveCapture$3);
          ctx.end(evt);
        },
        ...
        start: function start (evt, mouseEvent, keyboardEvent) {
          ...
          var fn = function () {
            ...
            if (ctx.event.repeatCount === 0) {
              ...
              document.addEventListener('click', stopAndPrevent, notPassiveCapture$4);
              ctx.eventStarter === 'touch' && document.addEventListener('contextmenu', stopAndPrevent, notPassiveCapture$4);
            }
        ...
        move: function move (evt) {
          ...
          if (ctx.event !== void 0 && ctx.event.repeatCount > 0) {
            setTimeout(function () {
              document.removeEventListener('click', stopAndPrevent, notPassiveCapture$4);
              eventStarter === 'touch' && document.removeEventListener('contextmenu', stopAndPrevent, notPassiveCapture$4);
            }, 50);
          }
    ...
    unbind: function unbind (el, ref) {
      ...
      if (ctx !== void 0) {
        ...
        if (ctx.event !== void 0 && ctx.event.repeatCount > 0) {
          document.removeEventListener('click', stopAndPrevent, notPassiveCapture$4);
          ctx.eventStarter === 'touch' && document.removeEventListener('contextmenu', stopAndPrevent, notPassiveCapture$4);
        }
  ...
  function set (key, val, opts, ssr) {
    ...
    if (ssr) {
      ...
      if (expire !== void 0 && expireValue < 0) {
        var oldVal = get(key, ssr, void 0, true);
        if (oldVal !== undefined) {
          var replaceKeyValue = (encode(key)) + "=" + (stringifyCookieValue(oldVal));
          all = all
  ...
  function getObject (ctx) {
    ...
    return {
      get: function (key, reviverFn) { return get(key, ssr, reviverFn); },
      set: function (key, val, opts) { return set(key, val, opts, ssr); },
      has: function (key, reviverFn) { return has(key, ssr, reviverFn); },
      remove: function (key, options) { return remove(key, options, ssr); },
      getAll: function (reviverFn) { return get(null, ssr, reviverFn); }
    }
  }
  ...
  function decode$1 (value, reviverFn) {
