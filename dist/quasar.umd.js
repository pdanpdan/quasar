/*!
 * Quasar Framework v1.0.0-alpha.10.1
...
(function (global, factory) {
  ...
  var QAvatar = Vue.extend({
    ...
    computed: {
      contentClass: function contentClass () {
        ...
        return ( obj = {}, obj[("bg-" + (this.color))] = this.color, obj[("text-" + (this.textColor) + " q-chip--colored")] = this.textColor, obj['q-avatar__content--square'] =  this.square, obj['generic-border-radius'] =  this.rounded, obj )
      },
      ...
      __getContent: function __getContent (h) {
        ...
        if (this.pointing) {
          child.push(h('div', {
            ...
            class: ( obj = {}, obj[("q-chip__pointer--" + (this.pointing))] = true, obj[("text-" + (this.color))] = this.color, obj )
          }));
  ...
  var QTabs = Vue.extend({
    ...
    methods: {
      ...
      __updateContainer: function __updateContainer (ref) {
        ...
        var scroll = this.$refs.content.scrollWidth - (this.scrollable ? this.extraOffset : 0) > width;
    ...
    if (onlyIcons) {
      ...
      Items = btn.options.map(function (btn) {
        ...
        return h(
          QItem,
          {
            props: { active: active, activeClass: activeClass, clickable: true, disable: disable },
            on: {
              click: function click (e) {
                closeDropdown();
  ...
  var QItemLabel = Vue.extend({
    ...
    computed: {
      classes: function classes () {
        var title = !this.overline && !this.caption;
  ...
  var QLinearProgress = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        return ( obj = {}, obj[("text-" + (this.color))] = this.color !== void 0, obj['q-linear-progress--reverse'] =  this.reverse === true || this.query === true, obj['generic-border-radius'] =  this.rounded === true, obj )
      },
  ...
  var QSpinnerCircles = Vue.extend({
  ...
  var QMarkupTable = Vue.extend({
    ...
    computed: {
      classes: function classes () {
        ...
        return ( obj = {}, obj[("q-table--" + (this.separator) + "-separator")] = true, obj['q-table--dark'] =  this.dark, obj['q-table--dense'] =  this.dense, obj['q-table--flat'] =  this.flat, obj['q-table--bordered'] =  this.bordered, obj )
      }
    },
