/*!
 * Quasar Framework v1.0.0-beta.8.1
    ...
    methods: {
      ...
      __pickAnchorEl: function __pickAnchorEl () {
        if (typeof this.target === 'string' || this.target instanceof Element) {
          var el = this.target instanceof Element ? this.target : document.querySelector(this.target);
          if (el !== null) {
            this.anchorEl = el;
            this.__configureAnchorEl();
          }
      ...
      __render: function __render (h) {
        return h('transition', {
          ...
          this.showing === true ? h('div', {
            ...
            style: this.contentStyle,
            attrs: this.$attrs,
            on: this.autoClose === true ? Object.assign({}, this.$listeners,
              {click: this.__onAutoClose}) : this.$listeners,
  ...
  */
  ...
  var QSelect = Vue.extend({
    ...
    methods: {
      ...
      __hidrateOptions: function __hidrateOptions (updatePosition) {
        var this$1 = this;
          ...
          if (this.optionsToShow < this.options.length) {
            ...
            if (el.scrollHeight - el.scrollTop - el.clientHeight < 200) {
              ...
              this.$nextTick(function () {
                ...
                this$1.__hidrateOptions(updatePosition);
              });
    ...
    methods: {
      ...
      __uploadBatch: function __uploadBatch (files) {
        ...
        if (this.fields !== void 0) {
          var fields = this.xhrProps.fields(files);
        ...
        var sendRaw = this.xhrProps.sendRaw(files);

        files.forEach(function (file) {
          this$1.__updateFile(file, 'uploading', 0);
          if (sendRaw !== true) {
            form.append(this$1.xhrProps.fieldName(file), file);
          }
          file.xhr = xhr;
