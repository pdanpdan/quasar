/*!
 * Quasar Framework v1.0.5-test.13
...
(function (global, factory) {
  ...
  var AnchorMixin = {
    ...
    created: function created () {
      ...
      if (typeof this.__configureScrollTarget === 'function' && typeof this.__unconfigureScrollTarget === 'function') {
        this.$watch('noParentEvent', function () {
  ...
  var ModelToggleMixin = {
    ...
    computed: {
      navigationHideCondition: function navigationHideCondition () {
    ...
    methods: {
      ...
      show: function show (evt) {
        ...
        var fn = typeof this.$listeners.input === 'function'
          ? function () { this$1.value !== true && this$1.$emit('input', true); }
          : function () { this$1.__processShow(evt); };
      ...
      __processShow: function __processShow (evt) {
        ...
        if (this.$options.modelToggle !== void 0 && this.$options.modelToggle.history === true) {
          this.__historyEntry = {
            condition: function () { return this$1.navigationHideCondition },
            handler: this.hide
          };
      ...
      var ctx = {
        ...
        move: function move (evt) {
          ...
          if (ctx.event.isFirst === true) {
            ...
            fn !== void 0 && document.addEventListener('click', fn, notPassiveCapture$1);
          ...
          if (ctx.event.detected === true) {
            ...
            fn !== void 0 && setTimeout(function () {
              document.removeEventListener('click', fn, notPassiveCapture$1);
            }, 50);
      ...
      if (ctx !== void 0) {
        ...
        if (ctx.event !== void 0) {
          ...
          if (ctx.event.detected === true) {
            ...
            fn !== void 0 && document.removeEventListener('click', fn, notPassiveCapture$1);
  ...
  */
  ...
  function prevent$1 (register) {
    ...
    var action = register === true ? 'add' : 'remove';
      ...
      activeState: function activeState (state) {
        ...
        setTimeout(function () {
          if (state === this$1.activeState && state !== this$1.lastState) {
            this$1.$emit(state === true ? 'activate' : 'deactivate');
  ...
  var QDrawer = Vue.extend({
    ...
    methods: {
      ...
      __setScrollable: function __setScrollable (v) {
        if (v !== true) {
          document.body.classList.remove('q-body--drawer-toggle');
        }
        else if (this.layout.container !== true) {
          document.body.classList.add('q-body--drawer-toggle');
        }
      },
  ...
  var QRating = Vue.extend({
    ...
    render: function render (h) {
      ...
      var loop = function ( i ) {
        var
          iconActive = (!this$1.mouseModel && this$1.value >= i) || (this$1.mouseModel && this$1.mouseModel >= i),
          iconExSelected = this$1.mouseModel && this$1.value >= i && this$1.mouseModel < i,
          iconName = (iconActive === true || iconExSelected === true) && iconSelected !== void 0
            ? i <= iconSelectedLength ? this$1.iconSelected[i - 1] : iconSelected
            : i <= iconLength ? this$1.icon[i - 1] : icon;
        ...
        child.push(
          h(QIcon, {
            ...
            props: { name: iconName || this$1.$q.iconSet.rating.icon },
  ...
  var VirtualList = {
    ...
    methods: {
      scrollTo: function scrollTo (toIndex, scrollUp) {
      ...
      __onVirtualListScroll: function __onVirtualListScroll () {
        ...
        var ref = getScrollDetails(scrollEl, this.__getVirtualListEl(), this.horizontal);
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, align) {
        ...
        var ref = getScrollDetails(scrollEl, void 0, this.horizontal);
        var scrollStart = ref.scrollStart;
        ...
        this.$nextTick(function () {
          ...
          if (from !== prevFrom || to !== prevTo) {
            var
              ...
              paddingSize = this$1.horizontal === true ? 'width' : 'height';
            ...
            if (contentEl !== void 0) {
              ...
              for (var i = children.length - 1; i >= 0; i--) {
                var
                  index = from + i,
                  diff = children[i][this$1.horizontal === true ? 'offsetWidth' : 'offsetHeight'] - this$1.virtualListSizes[index];
      ...
      __padVirtualList: function __padVirtualList (h, content, useBg) {
        var obj, obj$1;
  ...
  var TouchHold = {
      ...
      var ctx = {
        mouseStart: function mouseStart (evt) {
          ...
          if (ctx.eventStarter === void 0 && leftClick(evt)) {
            ...
            document.addEventListener('mouseup', ctx.mouseEnd, passiveCapture$1);
            ctx.start(evt, true);
          }
        },
        ...
        mouseEnd: function mouseEnd (evt) {
          ...
          document.removeEventListener('mouseup', ctx.mouseEnd, passiveCapture$1);
          ctx.end(evt);
        },
        ...
        touchStart: function touchStart (evt) {
          ...
          if (ctx.eventStarter === void 0 && touchTarget !== void 0) {
            ...
            touchTarget.addEventListener('touchcancel', ctx.touchEnd, passiveCapture$1);
            touchTarget.addEventListener('touchend', ctx.touchEnd, passiveCapture$1);
            ctx.start(evt);
          }
        },
        ...
        touchEnd: function touchEnd (evt) {
          ...
          if (touchTarget !== void 0) {
            ...
            touchTarget.removeEventListener('touchcancel', ctx.touchEnd, passiveCapture$1);
            touchTarget.removeEventListener('touchend', ctx.touchEnd, passiveCapture$1);
          }
          ctx.end(evt);
        },
        ...
        start: function start (evt, mouseEvent) {
          ...
          ctx.timer = setTimeout(function () {
            ...
            document.addEventListener('click', stopAndPrevent, notPassiveCapture$2);
            ctx.eventStarter === 'touch' && document.addEventListener('contextmenu', stopAndPrevent, notPassiveCapture$2);
          ...
          if (ctx.triggered === true) {
            setTimeout(function () {
              document.removeEventListener('click', stopAndPrevent, notPassiveCapture$2);
              eventStarter === 'touch' && document.removeEventListener('contextmenu', stopAndPrevent, notPassiveCapture$2);
            }, 50);
          }
          else {
            clearTimeout(ctx.timer);
    ...
    unbind: function unbind (el, ref) {
      ...
      if (ctx !== void 0) {
        ...
        if (ctx.triggered === true) {
          document.removeEventListener('click', stopAndPrevent, notPassiveCapture$2);
          ctx.eventStarter === 'touch' && document.removeEventListener('contextmenu', stopAndPrevent, notPassiveCapture$2);
        }
    ...
    bind: function bind (el, ref) {
      ...
      var keyboard = Object.keys(modifiers).reduce(function (acc, key) {
        if (keyRegex.test(key) === true) {
          var keyCode = isNaN(key) ? keyCodes$2[key.toLowerCase()] : parseInt(key, 10);
      ...
      var ctx = {
        ...
        keyboardStart: function keyboardStart (evt) {
          if (ctx.eventStarter === void 0 && keyboard.includes(evt.keyCode)) {
            el.focus();
            el.addEventListener('blur', ctx.keyboardEnd, passiveCapture$2);
            document.addEventListener('keyup', ctx.keyboardEnd, passiveCapture$2);
            ctx.start(evt, false, true);
          }
        },

        keyboardEnd: function keyboardEnd (evt) {
          el.removeEventListener('blur', ctx.keyboardEnd, passiveCapture$2);
          document.removeEventListener('keyup', ctx.keyboardEnd, passiveCapture$2);
          ctx.end(evt);
        },
