/*!
 * Quasar Framework v1.0.0-rc.4.7
          ...
          if (this.type === 'submit') {
            ...
            if (
              (
                ...
                activeElement !== parent(this.$el, function (el) { return el.hasAttribute('tabindex'); })
              ) ||
  ...
  var QMenu = Vue.extend({
    ...
    methods: {
      ...
      updatePosition: function updatePosition () {
        ...
        var el = this.__portal === void 0 ? { nodeType: 8 } : this.__portal.$el;
