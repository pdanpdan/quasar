/*!
 * Quasar Framework v1.0.0-beta.17.3
      ...
      var ctx = {
        ...
        handler: function handler (evt) {
          ...
          if (target && target !== document.body) {
            var related = (arg !== void 0 ? Object.values(arg) : []).concat(el);
    ...
    methods: {
      __show: function __show (evt) {
        ...
        this.timer = setTimeout(function () {
          ...
          if (this$1.touchPosition && (evt !== void 0 || this$1.touchPositionEvent !== void 0)) {
          ...
          this$1.timer = setTimeout(function () {
            ...
            if (
              this$1.noFocus !== true &&
              this$1.__portal.$refs !== void 0 &&
              this$1.__portal.$refs.inner !== void 0
            ) {
              this$1.__portal.$refs.inner.focus();
            }
          }, 300);
        }, 0);
      },
  ...
  var TouchSwipe = {
    ...
    bind: function bind (el, binding) {
      ...
      var ctx = {
        ...
        mouseEndClick: function mouseEndClick (evt) {
  ...
  */
  ...
  var QDialog = Vue.extend({
    ...
    methods: {
      ...
      __onChangeFocus: function __onChangeFocus (e) {
        if (
          this.__portal === void 0 ||
  ...
  var QField = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        return ( obj = {}, obj[this.fieldClass] = this.fieldClass !== void 0, obj[("q-field--" + (this.styleType))] = true, obj['q-field--rounded'] =  this.rounded, obj['q-field--square'] =  this.square, obj['q-field--focused'] =  this.focused === true || this.hasError === true, obj['q-field--float'] =  this.floatingLabel, obj['q-field--labeled'] =  this.label !== void 0, obj['q-field--dense'] =  this.dense, obj['q-field--item-aligned q-item-type'] =  this.itemAligned, obj['q-field--dark'] =  this.dark, obj['q-field--auto-height'] =  this.__getControl === void 0, obj['q-field--with-bottom'] =  this.hasBottom, obj['q-field--error'] =  this.hasError, obj['q-field--readonly'] =  this.readonly, obj['q-field--disabled'] =  this.disable, obj )
      },
  ...
  function cloneFileList (original) {
    ...
    var dataTransfer = new ClipboardEvent('').clipboardData || // Firefox < 62 workaround exploiting https://bugzilla.mozilla.org/show_bug.cgi?id=1422655
      new DataTransfer(); // specs compliant (as of March 2018 only Chrome)

    Array.from(original).forEach(function (file) {
    ...
    methods: {
      ...
      __onInput: function __onInput (e) {
        if (this.type === 'file') {
          ...
          var files = cloneFileList(e.target.files);
  ...
  var QPopupProxy = Vue.extend({
    ...
    methods: {
      ...
      __show: function __show (evt) {
        this.$listeners.show !== void 0 && this.$emit('show', evt);
      },
      ...
      __getMenu: function __getMenu (h) {
        ...
        return h(QMenu, {
          ...
          on: {
            ...
            'before-show': function (e) {
              this$1.$nextTick(function () {
                this$1.__onControlFocusin(e);
              });
            },
            hide: function (e) {
              this$1.__closeMenu();
              this$1.__onControlFocusout(e);
            }
          }
        ...
        var content = [
          h(QField, {
            ...
            scopedSlots: Object.assign({}, this.$scopedSlots,
              {control: function () { return this$1.__getControl(h, true); },
              before: void 0,
              after: void 0})
          })
        ];
    ...
    bind: function bind (el, ref, vnode) {
      ...
      var ctx = {
        ...
        handler: function handler (evt) {
          ...
          ctx.enabled !== false && evt.defaultPrevented !== true && setTimeout(function () {
