/*!
 * Quasar Framework v1.0.5-test.5
...
(function (global, factory) {
  ...
  */
  ...
  var VirtualList = {
    ...
    watch: {
      options: {
        handler: function handler (options) {
          var virtualListLength = Array.isArray(options) === false ? 0 : options.length;
          ...
          var virtualListSizes = new Array(virtualListLength);
    ...
    computed: {
      virtualListSlice: function virtualListSlice () {
    ...
    methods: {
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, target, fromScroll, scrollOffset) {
        ...
        this.$nextTick(function () {
          ...
          var
            margin = this$1.virtualListSizes.slice(from).reduce(function (acc, h) { return acc + h; }, 0),
            size = margin + this$1.virtualListSizes.slice(0, from).reduce(function (acc, h) { return acc + h; }, 0),
            padding = this$1.virtualListSize % this$1.virtualListMaxPadding + size - this$1.virtualListSize;

          if (this$1.virtualListMargin !== margin || this$1.virtualListSize !== size) {
            this$1.virtualListMargin = margin;
            ...
            content.previousSibling.style.cssText = padding >= 0
              ? ((this$1.__domProps.size) + ": " + padding + "px; " + (this$1.__domProps.marginCSS) + ": 0px")
              : ((this$1.__domProps.size) + ": 0px; " + (this$1.__domProps.marginCSS) + ": " + padding + "px");
            content.style[this$1.__domProps.margin] = "-" + margin + "px";
          }
      ...
      __padVirtualList: function __padVirtualList (h, content, useBg) {
        ...
        list.push(h('div', {
          ...
          style: ( obj$2 = {}, obj$2[this.__domProps.margin] = ("-" + (this.virtualListMargin) + "px"), obj$2 )
        }, content));

        return list
      },

      __resetVirtualListSlice: function __resetVirtualListSlice (index) {
  ...
  var QSelect = Vue.extend({
    ...
    computed: {
      ...
      optionScope: function optionScope () {
        ...
        return this.virtualListSlice.map(function (opt, i) {
  ...
  var QVirtualList = Vue.extend({
    ...
    computed: {
      listScope: function listScope () {
        ...
        return this.virtualListSlice.map(function (item, i) { return ({
    ...
    render: function render (h) {
      ...
      var
        attrs = this.__scrollTarget !== this.$el ? this.$attrs : Object.assign({}, {tabindex: 0},
          this.$attrs),
