/*!
 * Quasar Framework v1.0.0-beta.1
...
(function (global, factory) {
  ...
  var TouchPan = {
    ...
    bind: function bind (el, binding) {
      ...
      var ctx = {
        ...
        move: function move (evt) {
          ...
          if (!ctx.event.abort || (mouse && binding.modifiers.mousePrevent)) {
        ...
        end: function end (evt, mouseEvent) {
    ...
    unbind: function unbind (el, binding) {
      ...
      if (ctx !== void 0) {
        var evtOpts = binding.modifiers.mightPrevent || binding.modifiers.prevent
          ? null
          : listenOpts.passive;
  ...
  var DateTimeMixin = {
    ...
    methods: {
      ...
      __padYear: function __padYear (unit) {
        if (unit < 0 || unit > 9999) {
          return '' + unit
        }
  ...
  var QDate = Vue.extend({
    ...
    computed: {
      ...
      headerTitle: function headerTitle () {
        ...
        var date$$1 = new Date(model.year, model.month, model.day);
        if (isNaN(date$$1.valueOf())) { return ' --- ' }

        return this.$q.lang.date.daysShort[ date$$1.getDay() ] + ', ' +
      ...
      evtFn: function evtFn () {
        ...
        return typeof this.events === 'function'
          ? this.events
          : function (date$$1) { return this$1.events.includes(date$$1); }
      },
      ...
      evtColor: function evtColor () {
        ...
        return typeof this.eventColor === 'function'
          ? this.eventColor
          : function (date$$1) { return this$1.eventColor; }
      },
      ...
      isInSelection: function isInSelection () {
        ...
        return typeof this.options === 'function'
          ? this.options
          : function (date$$1) { return this$1.options.includes(date$$1); }
      },
      ...
      days: function days () {
        ...
        var
          date$$1 = new Date(this.innerModel.year, this.innerModel.month - 1, 1),
          endDay = (new Date(this.innerModel.year, this.innerModel.month - 1, 0)).getDate(),
          days = (date$$1.getDay() - this.computedFirstDayOfWeek - 1),
          res = [];
    ...
    methods: {
      ...
      __updateValue: function __updateValue (date$$1) {
        if (date$$1.year === void 0) {
          date$$1.year = this.innerModel.year;
        }
        if (date$$1.month === void 0) {
          date$$1.month = this.innerModel.month;
        }
        if (date$$1.day === void 0) {
          date$$1.day = Math.min(this.innerModel.day, this.daysInMonth);
        }

        var val = this.__padYear(date$$1.year) + '/' +
          this.__pad(date$$1.month) + '/' +
          this.__pad(date$$1.day);
      ...
      __pan: function __pan (evt) {
        ...
        if (evt.isFirst) {
          ...
          if (this.$scopedSlots.left !== void 0) {
            var slot$$1 = this.$refs.leftContent;
            slot$$1.style.transform = "scale3d(1,1,1)";
            this.__size.left = slot$$1.getBoundingClientRect().width;
          }
  ...
  var QStepper = Vue.extend({
    ...
    computed: {
      classes: function classes () {
        ...
        return ( obj = {}, obj[("q-stepper--" + (this.vertical ? 'vertical' : 'horizontal'))] = true, obj['q-stepper--flat no-shadow'] =  this.flat || this.dark, obj['q-stepper--bordered'] =  this.bordered || (this.dark && !this.flat), obj['q-stepper--contracted'] =  this.contracted, obj['q-stepper--dark'] =  this.dark, obj )
      }
    },
  ...
  var components$1 = /*#__PURE__*/Object.freeze({
    ...
    QTree: QTree,
    QUploader: QUploader,
    QUploaderBase: UploaderBaseMixin,
    QVideo: QVideo
  });
