    ...
    methods: {
      ...
      __preventFocusout: function __preventFocusout (state) {
        ...
        if (this.$q.platform.is.ios === true) {
          document.body[action]('focusout', this.__onFocusChangeOut, true);
        }
      },
      ...
      __hasSoftKeyboard: function __hasSoftKeyboard (e) {
        var isField = ['input', 'textarea'].indexOf(e.target.nodeName.toLowerCase()) > -1;

        return {
          isField: isField,
          hasKeyboard: isField === true ||
      ...
      __onFocusChange: function __onFocusChange (e) {
        ...
        if (this.$q.platform.is.ios === true) {
          var kbd = this.__hasSoftKeyboard(e);
      ...
      __onFocusChangeOut: function __onFocusChangeOut (e) {
  ...
  var QSplitter = Vue.extend({
    ...
    computed: {
      ...
      styles: function styles () {
        ...
        var styles = this.__cssValues(this.value);

        return {
          before: ( obj = {}, obj[this.prop] = styles.before, obj ),
          after: ( obj$1 = {}, obj$1[this.prop] = styles.after, obj$1 )
        }
      }
    },
    ...
    methods: {
      __pan: function __pan (evt) {
        ...
        var ref = this.__cssValues(this.__normalized);
      ...
      __cssValues: function __cssValues (val) {
        var
