...
(function (global, factory) {
    ...
    bind: function bind (el, binding) {
      ...
      var ctx = {
        ...
        start: function start (evt, mouseEvent) {
          ...
          var target = evt.target;
          ctx.targetObserver = new MutationObserver(function () {
            if (el.contains(target) === false) {
              ctx[mouseEvent === true ? 'mouseEnd' : 'end'](evt);
            }
          });
  ...
  var QField = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        return ( obj = {}, obj[this.fieldClass] = this.fieldClass !== void 0, obj[("q-field--" + (this.styleType))] = true, obj['q-field--rounded'] =  this.rounded, obj['q-field--square'] =  this.square, obj['q-field--focused'] =  this.focused === true || this.hasError === true, obj['q-field--float'] =  this.floatingLabel || this.hasError === true, obj['q-field--labeled'] =  this.label !== void 0, obj['q-field--dense'] =  this.dense, obj['q-field--item-aligned q-item-type'] =  this.itemAligned === true, obj['q-field--dark'] =  this.dark === true, obj['q-field--with-bottom'] =  this.hasBottom === true, obj['q-field--error'] =  this.hasError === true, obj['q-field--readonly no-pointer-events'] =  this.readonly === true, obj['disabled no-pointer-events'] =  this.disable === true, obj )
      },
  ...
  var QPopupProxy = Vue.extend({
    ...
    render: function render (h) {
      ...
      var slotDefault = slot(this, 'default');
