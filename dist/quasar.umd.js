/*!
 * Quasar Framework v1.0.5-test.17
...
(function (global, factory) {
  ...
  */
  ...
  function getScrollDetails (parent, child, horizontal) {
    ...
    if (parentCalc === void 0 || parentCalc === null || parentCalc.nodeType === 8) {
      return
    }
  ...
  function setScroll$1 (parent, scroll, horizontal) {
    if (parent === void 0 || parent === null || parent.nodeType === 8) {
      return
    }
    if (parent === window) {
      if (horizontal === true) {
  ...
  var VirtualList = {
    ...
    methods: {
      ...
      __onVirtualListScroll: function __onVirtualListScroll () {
        ...
        var scrollDetails = getScrollDetails(scrollEl, this.__getVirtualListEl(), this.virtualListHorizontal);
        ...
        this.__setVirtualListSliceRange(scrollEl, scrollDetails, toIndex, void 0, this.virtualListSizes[toIndex] + listOffset);
      },

      __setVirtualListSliceRange: function __setVirtualListSliceRange (scrollEl, scrollDetails, toIndex, align, indexScrollOffset) {
        var this$1 = this;
        if ( indexScrollOffset === void 0 ) indexScrollOffset = 0;
        ...
        var rangeChanged = from !== this.virtualListSliceRange.from || to !== this.virtualListSliceRange.to;
        ...
        this.$nextTick(function () {
          ...
          var
            posStart = this$1.virtualListSizes.slice(from, toIndex).reduce(function (acc, h) { return acc + h; }, scrollDetails.offsetStart + this$1.virtualListPaddingBefore),
          ...
          if (align !== void 0) {
            setScroll$1(
              ...
              this$1.virtualListHorizontal
            );
          }
          else if (rangeChanged === true && this$1.virtualListScrollSafari !== true) {
            setScroll$1(
              scrollEl,
