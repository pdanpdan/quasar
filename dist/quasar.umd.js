  ...
  var QField = Vue.extend({
    ...
    computed: {
      ...
      classes: function classes () {
        ...
        return ( obj = {}, obj[this.fieldClass] = this.fieldClass !== void 0, obj[("q-field--" + (this.styleType))] = true, obj['q-field--rounded'] =  this.rounded, obj['q-field--square'] =  this.square, obj['q-field--focused'] =  this.focused === true || this.hasError === true, obj['q-field--float'] =  this.floatingLabel, obj['q-field--labeled'] =  this.label !== void 0, obj['q-field--dense'] =  this.dense, obj['q-field--item-aligned q-item-type'] =  this.itemAligned, obj['q-field--dark'] =  this.dark, obj['q-field--with-bottom'] =  this.hasBottom, obj['q-field--error'] =  this.hasError, obj['q-field--readonly no-pointer-events'] =  this.readonly, obj['disabled no-pointer-events'] =  this.disable, obj )
      },
