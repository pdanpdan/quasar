/*!
 * Quasar Framework v1.0.4-test.6
  ...
  */
  ...
  var QDrawer = Vue.extend({
    ...
    methods: {
      ...
      __forceHide: function __forceHide (evt) {
        if ( evt === void 0 ) evt = true;
  ...
  var VirtualList = {
    ...
    watch: {
      options: {
        handler: function handler (options) {
          ...
          var defaultHeight = this.virtualListItemDefaultHeight;
          var virtualListHeights = new Array(virtualListLength);
    ...
    methods: {
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, target, fromScroll) {
        ...
        this.$nextTick(function () {
          var content = target === void 0 ? null : target.querySelector('.q-virtual-list--content');
          ...
          for (var i = children.length - 1; i >= 0; i--) {
            var diff = children[i].clientHeight - this$1.virtualListHeights[from + i];

            if (diff !== 0) {
              marginTopDiff += diff;
              this$1.virtualListHeights[from + i] += diff;
            }
          }

          var
            marginTop = this$1.virtualListHeights.slice(from).reduce(function (acc, h) { return acc + h; }, 0),
            height = marginTop + this$1.virtualListHeights.slice(0, from).reduce(function (acc, h) { return acc + h; }, 0),
            padding = this$1.virtualListHeight % this$1.virtualListMaxPadding + height - this$1.virtualListHeight;

          if (this$1.virtualListMarginTop !== marginTop || this$1.virtualListHeight !== height) {
            this$1.virtualListMarginTop = marginTop;
            this$1.virtualListHeight = height;
          ...
          if (repositionScroll === true) {
            if (fromScroll !== true) {
              this$1.__setPreventNextScroll(fromScroll);
              target.scrollTop = this$1.virtualListHeights.slice(0, toIndex).reduce(function (acc, h) { return acc + h; }, 0) + (
                this$1.$q.platform.is.mobile === true
                  ? 0
                  : Math.trunc(this$1.virtualListHeights[toIndex] / 2 - target.clientHeight / 2)
              );
            }
      ...
      __onTargetKeydownVirtualList: function __onTargetKeydownVirtualList (e) {
        // up, down
        ...
        if (e.keyCode === 38 || e.keyCode === 40) {
          ...
          if (this.menu === true) {
            var index = this.virtualListItemSelectedIndex;
            do {
      ...
      __padVirtualList: function __padVirtualList (h, content) {
        ...
        for (var i = Math.trunc(this.virtualListHeight / this.virtualListMaxPadding); i > 0; i--) {
      ...
      __resetVirtualListSlice: function __resetVirtualListSlice (optionIndex) {
  ...
  var QSelect = Vue.extend({
      ...
      optionScope: function optionScope () {
        ...
        return this.virtualListSlice.map(function (opt, i) {
          ...
          if (disable !== true) {
            ...
            this$1.virtualListItemSelectedIndex === index && (itemProps.focused = true);
          }
    ...
    methods: {
      ...
      __onTargetKeydown: function __onTargetKeydown (e) {
        ...
        this.__onTargetKeydownVirtualList(e);
        ...
        if (this.virtualListItemSelectedIndex > -1 && this.virtualListItemSelectedIndex < this.options.length) {
          this.toggleOption(this.options[this.virtualListItemSelectedIndex]);
          return
        }
