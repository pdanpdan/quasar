/*!
 * Quasar Framework v1.0.5-test.16
  ...
  var VirtualList = {
    ...
    methods: {
      ...
      __onVirtualListScroll: function __onVirtualListScroll () {
        ...
        var scrollMaxSize = ref.scrollMaxSize;
        var offsetStart = ref.offsetStart;
        var offsetEnd = ref.offsetEnd;
        ...
        if (scrollStart <= offsetStart) {
          ...
          for (var i = listCenter; i >= 0 && toIndex < listLastIndex;) {
            toIndex++;
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, align) {
        ...
        this.$nextTick(function () {
          ...
          if (from !== prevFrom || to !== prevTo) {
            ...
            this$1.virtualListPaddingBefore = this$1.virtualListSizes.slice(0, from).reduce(function (acc, h) { return acc + h; }, 0);
            this$1.virtualListPaddingAfter = this$1.virtualListSizes.slice(to).reduce(function (acc, h) { return acc + h; }, 0);
      ...
      __resetVirtualList: function __resetVirtualList (toIndex) {
        ...
        this.virtualListPaddingBefore = this.virtualListSizes.slice(0, this.virtualListSliceRange.from).reduce(function (acc, h) { return acc + h; }, 0);
        this.virtualListPaddingAfter = this.virtualListSizes.slice(this.virtualListSliceRange.to).reduce(function (acc, h) { return acc + h; }, 0);
  ...
  var QUploaderBase = {
    ...
    methods: {
      ...
      __getBtn: function __getBtn (h, show, icon, fn) {
        if (show === true) {
          return h(QBtn, {
            staticClass: icon === 'add' ? 'q-uploader__input-btn' : null,
            props: {
              type: 'button',
