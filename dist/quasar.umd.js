  ...
  var QDialog = Vue.extend({
    ...
    computed: {
      ...
      __onTouchMove: function __onTouchMove () {
        return this.iosKeyboard === true ? function () { } : stopAndPrevent
      }
    },
    ...
    methods: {
      ...
      __show: function __show (evt) {
        ...
        this.__setTimeout(function () {
          if (
            document.activeElement &&
            document.activeElement.autofocus === true
          ) {
            document.activeElement[document.activeElement.scrollIntoViewIfNeeded !== void 0 ? 'scrollIntoViewIfNeeded' : 'scrollIntoView']();
          }
      ...
      __onFocusChange: function __onFocusChange (e) {
        ...
        if (this.$q.platform.is.ios === true && e !== void 0 && e.target !== void 0) {
          var nodeName = e.target.nodeName.toLowerCase();

          this.__setIosKeyboard(
            nodeName === 'textarea' ||
      ...
      __setIosKeyboard: function __setIosKeyboard (status) {
        ...
        if (this.iosKeyboard !== status) {
          ...
          if (status === true && this.useBackdrop === true) {
            document.scrollingElement.scrollTop = this.position === 'top'
              ? 0
              : (this.position === 'bottom' ? window.innerHeight : 150);
          }
        }
      },
    ...
    mounted: function mounted () {
      this.__processModelChange(this.value);
      this.__onTouchMove = stopAndPrevent;
    },
