/*!
 * Quasar Framework v1.0.0-rc.5.1
...
(function (global, factory) {
  ...
  function setPosition (cfg) {
    ...
    if (props.top >= anchorProps.top) {
      ...
      var offset = props.maxHeight === void 0 ? targetProps.bottom : Math.min(targetProps.bottom, props.maxHeight);
    ...
    if (props.left >= anchorProps.left) {
      ...
      var offset$1 = props.maxWidth === void 0 ? targetProps.right : Math.min(targetProps.right, props.maxWidth);
      cfg.el.style.left = 'auto';
      cfg.el.style.right = 'calc(100% - ' + Math.floor(props.left + offset$1) + 'px)';
    }
  ...
  var QSelect = Vue.extend({
    ...
    watch: {
      ...
      options: {
        handler: function handler (options) {
          ...
          this.optionsHeights = Array.from(Array(optionsLength), function () { return optionDefaultHeight; });
    ...
    methods: {
      ...
      __hydrateOptions: function __hydrateOptions (ev, toIndex) {
        ...
        if (ev.target === void 0 || ev.target.nodeType === 8 || (this.preventNextScroll === true && toIndex === void 0)) {
        ...
        var
          ...
          content = target.querySelector('.q-select__options--content');

        if (toIndex === void 0 || content === null) {
          var toIndexMax = this.options.length - 1;

          toIndex = -1;
          for (var i = Math.round(scrollTop + viewHeight / 2); i >= 0 && toIndex < toIndexMax;) {
            toIndex++;
            i -= this.optionsHeights[toIndex];
          }

          this.__setOptionsSliceRange(toIndex, target);
        ...
        if (childPosTop < scrollTop || childPosTop + child.clientHeight > scrollTop + viewHeight) {
          this.__setOptionsSliceRange(toIndex, target, true);
        }
      },

      __setPreventNextScroll: function __setPreventNextScroll () {
        var this$1 = this;

        clearTimeout(this.preventNextScrollTimer);

        this.preventNextScroll = true;
      ...
      __setOptionsSliceRange: function __setOptionsSliceRange (toIndex, target, scroll) {
        var this$1 = this;
        ...
        var
          ...
          repositionScroll = scroll !== true && from < this.optionsSliceRange.from;
        ...
        if (from !== this.optionsSliceRange.from || to !== this.optionsSliceRange.to) {
          ...
          requestAnimationFrame(function () {
            var content = target.querySelector('.q-select__options--content');
          ...
          requestAnimationFrame(function () {
            if (target !== void 0) {
              target.scrollTop = Math.max(
                0,
                this$1.optionsHeights.slice(0, toIndex).reduce(function (acc, h) { return acc + h; }, 0) + (
                  this$1.$q.platform.is.mobile === true
                    ? 0
                    : Math.round(this$1.optionsHeights[toIndex] / 2 - target.clientHeight / 2)
                )
              );
              this$1.__setPreventNextScroll();
            }
      ...
      __updateMenu: function __updateMenu (show) {
        ...
        if (show === true) {
          ...
          if (optionIndex === -1 || this.optionIndex !== optionIndex) {
            this.__setPreventNextScroll();
