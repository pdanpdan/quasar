/*!
 * Quasar Framework v1.3.0-test.1
  ...
  var QField = Vue.extend({
    ...
    data: function data () {
      return {
        ...
        innerLoading: false,
        targetUid: this.$attrs.for === void 0 ? 'qf_' + uid$1() : this.$attrs.for
      }
    },
    ...
    render: function render (h) {
      ...
      return h(
        ...
        this.props === void 0 || this.props.header === true
          ? on
          : Object.assign({}, on, {class: this.props.__trClass}),
        slot(this, 'default')
      )
    }
  });
