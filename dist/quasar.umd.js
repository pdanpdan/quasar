/*!
 * Quasar Framework v1.0.5-test.24
...
(function (global, factory) {
  ...
  */
  ...
  function getScrollDetails (parent, child, horizontal, beforeRef, afterRef) {
    var
    ...
    for (var el$1 = afterRef.nextElementSibling; el$1 !== null; el$1 = el$1.nextElementSibling) {
      ...
      details.scrollViewSize -= el$1[propElSize];
    }
    ...
    methods: {
      scrollTo: function scrollTo (toIndex, scrollTowardsEnd) {
        ...
        this.__setVirtualListSliceRange(
          scrollEl,
          getScrollDetails(scrollEl, this.__getVirtualListEl(), this.virtualListHorizontal, this.$refs.before, this.$refs.after),
      ...
      __onVirtualListScroll: function __onVirtualListScroll () {
        ...
        var
          scrollDetails = getScrollDetails(scrollEl, this.__getVirtualListEl(), this.virtualListHorizontal, this.$refs.before, this.$refs.after),
      ...
      __setVirtualListSliceRange: function __setVirtualListSliceRange (scrollEl, scrollDetails, toIndex, offset, align) {
        var this$1 = this;
        ...
        this.$nextTick(function () {
          ...
          var
            posStart = this$1.virtualListSizes.slice(from, toIndex).reduce(sumFn, scrollDetails.offsetStart + this$1.virtualListPaddingBefore),
      ...
      __resetVirtualList: function __resetVirtualList (toIndex) {
        ...
        var defaultSize = this.virtualListItemSize;
      ...
      __padVirtualList: function __padVirtualList (h, defaultSlot, listScope, defaultIsContent, paddingTag) {
        var obj, obj$1;

        if ( paddingTag === void 0 ) paddingTag = 'div';
        var
          list = [],
          paddingSize = this.virtualListHorizontal === true ? 'width' : 'height';

        list.push(h(paddingTag, {
        ...
        list.push(defaultIsContent === true
          ? defaultSlot({
            attrs: {
              class: 'q-virtual-list__content',
              key: 'content',
              ref: 'content'
            },
            list: listScope
  ...
  var QSelect = Vue.extend({
    ...
    methods: {
      ...
      __getOptions: function __getOptions (h) {
        ...
        return this.__padVirtualList(h, fn, this.optionScope)
      },
  ...
  var QVirtualList = Vue.extend({
    ...
    render: function render (h) {
      ...
      return h(this.component, {
        ...
        slot(this, 'before'),
        this.__padVirtualList(
          h,
          this.$scopedSlots.default,
          this.virtualListScope,
          this.contentSlot,
          this.paddingTag
        ),
        slot(this, 'after')
