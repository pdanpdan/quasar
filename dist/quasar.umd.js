  ...
  */
  ...
  var QTooltip = Vue.extend({
    ...
    methods: {
      ...
      __unconfigureScrollTarget: function __unconfigureScrollTarget () {
        if (this.scrollTarget !== void 0) {
          this.scrollTarget.removeEventListener('scroll', this.updatePosition, passive$1);
      ...
      __onTargetKeydown: function __onTargetKeydown (e) {
        ...
        if (optionsLength > 0 && this.useInput !== true && e.keyCode >= 48 && e.keyCode <= 90) {
          ...
          if (keyRepeat === true || searchRe.test(this.__getOptionLabel(this.options[index$1])) !== true) {
            do {
              index$1 = normalizeToInterval(index$1 + 1, 0, optionsLength - 1);
            }
  ...
  var reSplitValue = /^\s*(\+?(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:[eE][+-]?[0-9]+)?)\s*([^\s]*)\s*$/;
  ...
  var QSplitter = Vue.extend({
    ...
    computed: {
      ...
      computedValue: function computedValue () {
        var match = reSplitValue.exec(this.value);
      ...
      modelStyle: function modelStyle () {
        ...
        return ( obj = {}, obj[this.prop] = this.computedValue[3], obj )
      },

      restStyle: function restStyle () {
        var obj;

        return ( obj = {}, obj[this.prop] = 'calc(100% - ' + this.computedValue[3] + ')', obj )
      }
    },
