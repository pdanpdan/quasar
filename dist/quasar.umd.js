/*!
 * Quasar Framework v1.0.5-test.7
...
(function (global, factory) {
  ...
  function setPosition (cfg) {
    ...
    // restore whiteSpace
    cfg.el.style.whiteSpace = whiteSpace;
  }
  ...
  */
  ...
  var QInput = Vue.extend({
    ...
    methods: {
      focus: function focus () {
        this.$refs.input !== void 0 && this.$refs.input !== document.activeElement && this.$refs.input.focus();
      },
  ...
  var VirtualList = {
    ...
    watch: {
      virtualListOptionsLength: {
        handler: function handler (virtualListLength) {
          ...
          for (var i = virtualListLength - 1; i >= 0; i--) {
          ...
          var toIndex = virtualListLength < this.virtualListSliceRange.to
            ? virtualListLength - 1
            : Math.ceil((this.virtualListSliceRange.to + this.virtualListSliceRange.from) / 2);

          this.__hydrateVirtualList(this.__getVirtualListEl(), toIndex);
        },
        immediate: true
      },

      horizontal: function horizontal (horizontal$1) {
        this.__setSizeKeys(horizontal$1);
      }
    },

    computed: {
      virtualListOptionsLength: function virtualListOptionsLength () {
    ...
    methods: {
      __hydrateVirtualList: function __hydrateVirtualList (ev, toIndex) {
        var this$1 = this;
        ...
        if (content === null) {
          this.virtualListHidrateTimer = setTimeout(function () {
            this$1.__hydrateVirtualList({ target: this$1.__getVirtualListEl() }, toIndex);
          }, 10);
          ...
          if (toIndex !== void 0) {
            this.$nextTick(function () {
              var
                ...
                scroll = target[this$1.__domProps.scroll],
                viewSize = target[this$1.__domProps.targetSize],
                childPosStart = child === void 0 ? -1 : content[this$1.__domProps.offset] + child[this$1.__domProps.offset],
                childPosSize = child === void 0 ? this$1.virtualListItemDefaultSize : child[this$1.__domProps.childSize],
                childPosEnd = child === void 0 ? -1 : childPosStart + childPosSize;

              if (childPosStart < scroll) {
                target[this$1.__domProps.scroll] = childPosStart;
              }
              else if (childPosEnd - viewSize > scroll) {
                target[this$1.__domProps.scroll] = childPosEnd - viewSize;
              }
            });
          }
        ...
        if (fromScroll === true) {
          var toIndexMax = this.virtualListOptionsLength - 1;
          ...
          if (scroll === 0) {
            ...
            for (var i = scroll; i >= 0 && toIndex < toIndexMax;) {
              toIndex++;
      ...
      __getVirtualListSliceRange: function __getVirtualListSliceRange (toIndex) {
        var
      ...
      __getVirtualListSliceRangeTop: function __getVirtualListSliceRangeTop (toIndex) {
        var
          index = toIndex > 0 ? toIndex : 0,
          to = Math.min(this.virtualListSliceSizeComputed, index + this.virtualListSliceSizeComputed),
          from = Math.max(0, to - this.virtualListSliceSizeComputed);

        return { from: from, to: to }
      },

      __setVirtualListSliceRange: function __setVirtualListSliceRange (toIndex, target, fromScroll, scrollOffset) {
        var this$1 = this;
        if ( scrollOffset === void 0 ) scrollOffset = 0;

        var ref = this.__getVirtualListSliceRange(toIndex);
        var from = ref.from;
        var to = ref.to;
        var repositionScroll = to >= this.virtualListOptionsLength || fromScroll !== true || from < this.virtualListSliceRange.from;
        ...
        this.$nextTick(function () {
          var content = target === void 0 ? null : target.querySelector('.q-virtual-list__content');
          ...
          for (var i = children.length - 1; i >= 0; i--) {
            var diff = children[i][this$1.__domProps.childSize] - this$1.virtualListSizes[from + i];

            if (diff !== 0) {
              marginDiff += diff;
              this$1.virtualListSizes[from + i] += diff;
            }
          }

          var
            position = this$1.virtualListSizes.slice(from).reduce(function (acc, h) { return acc + h; }, 0),
            size = position + this$1.virtualListSizes.slice(0, from).reduce(function (acc, h) { return acc + h; }, 0),
            padding = this$1.virtualListSize % this$1.virtualListMaxPadding + size - this$1.virtualListSize;

          if (this$1.virtualListPosition !== position || this$1.virtualListSize !== size) {
            this$1.virtualListPosition = position;
            this$1.virtualListSize = size;
            ...
            content.previousSibling.style.cssText = padding >= 0
              ? ((this$1.__domProps.size) + ": " + padding + "px; " + (this$1.__domProps.margin) + ": 0px")
              : ((this$1.__domProps.size) + ": 0px; " + (this$1.__domProps.margin) + ": " + padding + "px");
            content.style[this$1.__domProps.position] = "-" + position + "px";
          }

          if (repositionScroll === true) {
            if (fromScroll !== true) {
              this$1.__setPreventNextScroll();
              target[this$1.__domProps.scroll] = this$1.virtualListSizes.slice(0, toIndex).reduce(function (acc, h) { return acc + h; }, 0) - scrollOffset;
            }
            else if (marginDiff !== 0 && toIndex > 0 && toIndex < this$1.virtualListOptionsLength) {
              this$1.__setPreventNextScroll(fromScroll);
              target[this$1.__domProps.scroll] += marginDiff;
            }
          }
        });
      },
      ...
      __padVirtualList: function __padVirtualList (h, content, useBg) {
        ...
        for (var i = Math.trunc(this.virtualListSize / this.virtualListMaxPadding); i > 0; i--) {
          list.push(h('div', { staticClass: staticClass, style: ( obj = {}, obj[this.__domProps.size] = ((this.virtualListMaxPadding) + "px"), obj ) }));
        }
        list.push(h('div', { staticClass: staticClass, style: ( obj$1 = {}, obj$1[this.__domProps.size] = ((this.virtualListSize % this.virtualListMaxPadding) + "px"), obj$1 ) }));

        list.push(h('div', {
          staticClass: 'q-virtual-list__content',
          class: this.virtualListContentClass,
          style: ( obj$2 = {}, obj$2[this.__domProps.position] = ("-" + (this.virtualListPosition) + "px"), obj$2 )
        }, content));

        return list
      },

      __resetVirtualListSlice: function __resetVirtualListSlice (toIndex) {
        this.__setPreventNextScroll(true);
        this.virtualListSliceRange = this.__getVirtualListSliceRangeTop(toIndex);
        this.__hydrateVirtualList({ target: this.__getVirtualListEl() }, toIndex);
      },

      __setSizeKeys: function __setSizeKeys (horizontal) {
        if (horizontal === true) {
          this.__domProps = {
            size: 'width',
  ...
  var QSelect = Vue.extend({
    ...
    computed: {
      ...
      optionScope: function optionScope () {
        ...
        return this.options.slice(this.virtualListSliceRange.from, this.virtualListSliceRange.to).map(function (opt, i) {
          var disable = this$1.__isDisabled(opt);
          var index = this$1.virtualListSliceRange.from + i;
    ...
    methods: {
      ...
      __removeAtIndexAndFocus: function __removeAtIndexAndFocus (index) {
        ...
        this.hasDialog !== true && this.focus();
      },
      ...
      setOptionIndex: function setOptionIndex (index) {
        ...
        var val = index > -1 && index < this.virtualListOptionsLength
          ? index
          : -1;
      ...
      __onTargetKeydown: function __onTargetKeydown (e) {
        ...
        // up, down
        var optionsLength = this.virtualListOptionsLength;
      ...
      __getMenu: function __getMenu (h) {
        ...
        return h(QMenu, {
          ...
          on: {
            '&scroll': this.__hydrateVirtualList,
      ...
      __getDialog: function __getDialog (h) {
        ...
        return h(QDialog, {
          ...
          on: {
            ...
            show: function () {
              this$1.$refs.target !== document.activeElement && this$1.hasDialog !== true && this$1.$refs.target.focus();
            }
          }
        }, [
          h('div', {
      ...
      __updateMenu: function __updateMenu (show) {
        ...
        if (show === true) {
          ...
          this.__resetVirtualListSlice(optionIndex);
        }
  ...
  var QVirtualList = Vue.extend({
    ...
    computed: {
      listScope: function listScope () {
        ...
        return this.options.slice(this.virtualListSliceRange.from, this.virtualListSliceRange.to).map(function (item, i) { return ({
