...
(function (global, factory) {
  ...
  function getPlatform (userAgent) {
    ...
    if (isSSR === false) {
      if (window.process && window.process.versions && window.process.versions.electron) {
        ...
        var prop = Object.keys(window._cordovaNative || window.cordova) === 0
          ? 'capacitor'
          : 'cordova';
  ...
  var History = {
    ...
    install: function install ($q, cfg) {
      ...
      var wrapper = $q.platform.is.nativeMobileWrapper;
      ...
      var exit = cfg[wrapper] === void 0 || cfg[wrapper].backButtonExit !== false;
