/*!
 * Quasar Framework v1.2.7-test.1
...
(function (global, factory) {
  ...
  */
  ...
  var inputTypesWithKeyboard = ['color', 'date', 'datetime-local', 'email', 'month', 'number', 'password', 'serach', 'tel', 'text', 'time', 'url', 'week', 'datetime'];
  ...
  var QDialog = Vue.extend({
    ...
    computed: {
      ...
      __onTouchMove: function __onTouchMove () {
    ...
    methods: {
      ...
      __show: function __show (evt) {
        ...
        var delays = this.__isIos === true && this.useBackdrop === true && this.position === 'bottom'
          ? [ 0, 300 ]
          : [ 100, 200 ];

        this.__setTimeout(function () {
          if (this$1.iosKeyboard === true && this$1.useBackdrop === true) {
            document.scrollingElement.scrollTop = this$1.position === 'bottom'
              ? window.innerHeight
              : this$1.position === 'top' ? 0 : (this$1.$q.screen.width < 400 ? 130 : 153);
          }

          this$1.__setTimeout(function () {
      ...
      __onFocusChange: function __onFocusChange (e) {
        ...
        if (this.__isIos === true && e !== void 0 && e.target !== void 0) {
          ...
          this.__setIosKeyboard(nodeName === 'textarea' ||
            ...
            (e.path !== void 0 && e.path.some(function (el) { return el.hasAttribute !== void 0 && el.hasAttribute('contenteditable'); }) === true)
          );
        }
      },

      // Only called on iOS to detect keyboard hide
      __onFocusoutChange: function __onFocusoutChange () {
        this.iosKeyboard === true && this.__setIosKeyboard(false);
      },

      __setIosKeyboard: function __setIosKeyboard (status) {
