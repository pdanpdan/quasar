...
export interface Notify {
    ...
    create (opts : {
            ...
            multiLine? : boolean
            /**
             * Key used (together with position) to group notifications together - only the first notification in the group will be shown, together with a badge with the number of grouped notifications
             */
            group? : string | number
            /**
             * QBadge props to be used for the group notification counter; Use false to hide badge; The value in the first notification in group are used
             */
            badgeProps? : LooseDictionary | boolean
            /**
             * Ignore the default configuration (set by setDefaults()) for this instance only
             */
    ...
    setDefaults (opts : {
             ...
             * QBadge props to be used for the group notification counter; Use false to hide badge; The value in the first notification in group are used
             */
            badgeProps? : LooseDictionary | boolean }): void
}
...
export interface QFab extends Vue {
    ...
    glossy? : boolean
    /**
     * Display extended Fab (icon and label)
     */
    extended? : boolean
    /**
    ...
    label? : string | number
    /**
     * Display label on the left of the icon when Fab is extended
     */
    leftLabel? : boolean
    /**
     * Put component in disabled mode
...
export interface QFabAction extends Vue {
    ...
    icon : string
    /**
     * How to align the Fab Action relative to Fab expand side (only when direction is 'up' or 'down'); By default it uses the align specified in QFab
     */
    align? : string
    /**
     * Equivalent to Vue Router <router-link> 'to' property
