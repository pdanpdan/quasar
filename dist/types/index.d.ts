...
export interface QDate extends Vue {
     ...
     * @param year Year
     */
    setMonthYear (month? : number | string, year? : number | string): void
    /**
...
export interface QForm extends Vue {
    ...
    greedy? : boolean
    /**
     * Validate the fields in form in the order they appear in DOM (by default it validates in the order they are in Vue internal children list) - Warning: high performance penalty
     */
    ordered? : boolean
    /**
...
export interface QInput extends Vue {
    ...
    value : string | number
    /**
     * Text to be displayed as shadow at the end of the text in the control
     */
    shadowText? : string
    /**
     * Input type
