...
export interface Cookies {
     ...
     */
    getAll (reviverFn? : Function): LooseDictionary
    /**
     * Set cookie
     * @param name Cookie name
...
export interface KeyGroupNavigation {
}
...
export interface QBtnDropdown extends Vue {
     ...
     */
    menuAnchor? : 'top left' | 'top middle' | 'top right' | 'top start' | 'top end' | 'center left' | 'center middle' | 'center right' | 'center start' | 'center end' | 'bottom left' | 'bottom center' | 'bottom right' | 'bottom start' | 'bottom end'
    /**
     * Two values setting the menu's own position relative to its target
     */
    menuSelf? : 'top left' | 'top middle' | 'top right' | 'top start' | 'top end' | 'center left' | 'center middle' | 'center right' | 'center start' | 'center end' | 'bottom left' | 'bottom center' | 'bottom right' | 'bottom start' | 'bottom end'
    /**
...
export interface QDate extends Vue {
    ...
    /**
     * Change current view's month and year; If either of the parameters is missing or invalid it'll be left as it is
     * @param month Month
     * @param year Year
     */
    setMonthYear (month? : number | '12', year? : number | '1999'): void
    /**
...
export interface QField extends Vue {
    ...
    labelColor? : string
    /**
     * Used together with outlined prop to switch to Meterial type outlined; Specifies the color name for the background of the label from the Quasar Color Palette
     */
...
export interface QMenu extends Vue {
     ...
     * Two values setting the starting position or anchor point of the menu relative to its target
     */
    anchor? : 'top left' | 'top middle' | 'top right' | 'top start' | 'top end' | 'center left' | 'center middle' | 'center right' | 'center start' | 'center end' | 'bottom left' | 'bottom center' | 'bottom right' | 'bottom start' | 'bottom end'
    /**
     * Two values setting the menu's own position relative to its target
     */
    self? : 'top left' | 'top middle' | 'top right' | 'top start' | 'top end' | 'center left' | 'center middle' | 'center right' | 'center start' | 'center end' | 'bottom left' | 'bottom center' | 'bottom right' | 'bottom start' | 'bottom end'
    /**
     * An array of two numbers to offset the menu horizontally and vertically in pixels
     */
    offset? : any[]
...
export interface QSelect extends Vue {
     ...
     * @param edge The edge to align to if the item is not visible already (by default it aligns to end if scrolling towards the end and to start otherwise)
     */
    scrollTo (index : string | number, edge? : 'start' | 'end'): void
    /**
...
export interface QuasarPluginOptions {
    ...
    directives: {
        ...
        KeyGroupNavigation?: KeyGroupNavigation
        Morph?: Morph
        Mutation?: Mutation
        Ripple?: Ripple
        Scroll?: Scroll
...
export const KeyGroupNavigation: KeyGroupNavigation
