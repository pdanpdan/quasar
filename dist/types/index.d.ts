...
export interface Dark {
    /**
     * Is Dark mode active? Has value `null` when on SSR and dark set to `auto`
     */
    isActive : boolean
    /**
...
export interface Interaction {
    /**
     * Last event was a keyboard one
     */
    isKeyboard : boolean
    /**
     * Last event was a keyboard composing one
     */
    isComposing : boolean
    /**
     * Last event was a pointer one (mouse or touch)
     */
    isPointer : boolean
    /**
     * Last event was a mouse one
     */
    isMouse : boolean
    /**
     * Last event was a touch one
     */
    isTouch : boolean
    /**
     * Last event was a drag and drop one
     */
    isDrag : boolean
    /**
     * Last event was a context menu one
     */
    isContext : boolean
    /**
     * Last event is in progress (start event without a cancel or end event)
     */
    isPending : boolean
    /**
     * Last event
     */
    event : LooseDictionary
    /**
     * Prevent next click event on a target element
     * @param target The element where it should prevent click
     * @param stop Stop propagation of the event
     */
    preventClick (target? : Element, stop? : boolean): void
}
...
export interface Loading {
    ...
    show (opts? : {
            ...
            delay? : number
            /**
             * Update content without showing transition
             */
            update? : boolean
            /**
             * Message to display
...
export interface QDate extends Vue {
    ...
    /**
     * On which end of the range to navigate the calendar when the model changes; Use `false` to skip navigation
     */
    modelNavigation? : 'from' | 'to' | boolean
    /**
    ...
    range? : boolean
    /**
     * Model single days as a range (object) instead of string
     */
    dayAsRange? : boolean
    /**
     ...
     * @param modelNavigation On which end of the range to navigate the calendar; Use `false` to skip navigation
     */
    setEditingRange (from? : {
             ...
             * The day of month
             */
            day? : number }, modelNavigation? : 'from' | 'to' | boolean): void
}
...
export interface QMenu extends Vue {
    ...
    noFocus? : boolean
    /**
     * The minimum height of the menu; Size in CSS units, including unit name
     */
    minHeight? : string
    /**
     * The minimum width of the menu; Size in CSS units, including unit name
     */
    minWidth? : string
    /**
...
export interface QSelect extends Vue {
    ...
    /**
     * Class definitions to be attributed to the dialog external element
     */
    dialogContentClass? : any[] | string | LooseDictionary
    /**
     * Style definitions to be attributed to the dialog external element
     */
    dialogContentStyle? : any[] | string | LooseDictionary
    /**
     * Style definitions to be attributed to the dialog external element
     */
...
export interface QTooltip extends Vue {
    ...
    value? : boolean
    /**
     * The minimum height of the Tooltip; Size in CSS units, including unit name
     */
    minHeight? : string
    /**
     * The minimum width of the Tooltip; Size in CSS units, including unit name
     */
    minWidth? : string
    /**
