...
export interface QPagination extends Vue {
    ...
    input? : boolean
    /**
     * Generate link for page buttons
     */
    toFn? : Function
    /**
...
export interface QSplitter extends Vue {
    ...
    /**
     * Apply the split size in pixels (by default is percent)
     */
    modelPixels? : boolean
    /**
    ...
    horizontal? : boolean
    /**
     * An array of two values representing the minimum and maximum split size of the two panes; Use Infinity as the second value to make it unbound on the upper side
     */
    limits? : any[]
    /**
     * Put component in disabled mode
