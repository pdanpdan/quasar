...
export interface Cookies {
     ...
     */
    get (name : string, reviverFn? : Function): string | null
    /**
     * Get all cookies
     * @param reviverFn Transformation function to be used for values - see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/parse#Using_the_reviver_parameter
     * @returns Object with cookie names (as keys) and their values
     */
    getAll (reviverFn? : Function): Object
    /**
     * Set cookie
     * @param name Cookie name
...
export interface LocalStorage {
     ...
     */
    getItem (key : string, reviverFn? : Function): Date | RegExp | number | boolean | Function | Object | any[] | string | null
    /**
     ...
     */
    getIndex (index : number, reviverFn? : Function): number | null
    /**
     ...
     */
    set (key : string, value : Date | RegExp | number | boolean | Function | Object | any[] | string | null): void
    /**
...
export interface QBtnDropdown extends Vue {
     ...
     */
    contentStyle? : any[] | string | Object
    /**
     * Class definitions to be attributed to the menu
     */
    contentClass? : any[] | string | Object
    /**
...
export interface QCarousel extends Vue {
    ...
    swipeable? : boolean
    /**
     * Use vertical direction for swipe (need swipeable activated)
     */
    ...
    arrows? : boolean
    /**
     * Show vertical navigation arrow buttons
     */
...
export interface QExpansionItem extends Vue {
     ...
     */
    expandIconClass? : any[] | string | Object
    /**
     ...
     */
    headerStyle? : any[] | string | Object
    /**
     * Apply custom class(es) to the header
     */
    headerClass? : any[] | string | Object
    /**
     * Triggers component to show
     * @param evt JS event object
     */
...
export interface QForm extends Vue {
     ...
     * @param evt JS event object
     */
    submit (evt? : Object): void
    /**
     * Manually trigger form reset
     * @param evt JS event object
     */
    reset (evt? : Object): void
}
...
export interface QPageScroller extends Vue {
    ...
    expand? : boolean
    /**
     * Scroll offset (in pixels) from which point the component is shown on page; Measured from the top of the page or from the bottom if 'scroll-reverse' is active
     */
    scrollOffset? : number
    /**
     * Work in reverse (when scrolling to the top of the page, and scroll to bottom)
     */
...
export interface QScrollArea extends Vue {
     ...
     */
    contentActiveStyle? : any[] | string | Object
    /**
...
export interface QSelect extends Vue {
     ...
     */
    popupContentStyle? : any[] | string | Object
    /**
