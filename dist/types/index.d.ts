...
export interface QCheckbox extends Vue {
    ...
    /**
     * Determines toggle order of the two states ('t' stands for state of true, 'f' for state of false); If 'toggle-indeterminate' is true, then the order is: indet -> first state -> second state -> indet, otherwise: indet -> first state -> second state -> first state -> second state -> ...
     */
    toggleOrder? : 'tf' | 'ft'
    /**
