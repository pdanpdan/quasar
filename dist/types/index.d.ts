...
export interface QSplitter extends Vue {
    /**
     * Model of the component defining the size (by default % if no unit is specified - 0.0 < x < 100.0) of the panes; Either use this property (along with a listener for 'input' event) OR use v-model directive
     */
    value? : number | string
    /**
     * Apply the split size value to the second pane (by default it applies to the first)
     */
    ...
    horizontal? : boolean
    /**
     * An array of two values representing a ratio of minimum and maximum split area of the two panes; Use Infinity as the second value to make it unbound on the upper side
     */
    limits? : any[]
    /**
     * Put component in disabled mode
