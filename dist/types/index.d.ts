...
export interface QField extends Vue {
    ...
    loading? : boolean
    /**
     * Appends clearable icon when a value (not undefined or null or clear-value) is set; When clicked, model becomes clear-value (default null)
     */
    clearable? : boolean
    /**
     * Value used for checking if the clearable icon should show and used to clear; If you use an object it should NOT BE LITERAL
     */
    clearValue? : any
    /**
