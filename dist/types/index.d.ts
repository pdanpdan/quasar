...
export interface QDate extends Vue {
    ...
    ranges? : any[] | Function
    /**
     * Date as String from where the selection starts; If present range selection mode is activated and the next day selection marks the end of range
     */
    rangeStart? : string
    /**
     * Date as String where the selection ends; If both this and range-start are present the range is marked as outlined
     */
    rangeEnd? : string
    /**
