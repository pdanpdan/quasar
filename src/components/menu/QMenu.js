...
import { create, stop, position, stopAndPreventClick, eventOnAncestors } from '../../utils/event.js'
...
export default Vue.extend({
  ...
  methods: {
    __show (evt) {
      ...
      EscapeKey.register(this, () => {
        if (this.persistent === true) {
          ...
          if (
            ...
            this.__refocusTarget.focus({ preventScroll: true })
          }
          else {
            this.__focusFirst()
          }
      ...
      this.__nextTick(() => {
        this.updatePosition()
        this.noFocus !== true && this.focus({ preventScroll: true })
      })
    ...
    __configureScrollTarget () {
      if (this.showing && (this.anchorEl !== void 0 || this.scrollTarget !== void 0)) {
        this.__changeScrollEvent(this.updatePosition)
      }
    },
    ...
    updatePosition (e) {
      if (this.anchorEl === void 0 || this.__portal === void 0 || this.settingPosition === true) {
        return
      }
      ...
      if (e && e.type === 'scroll' && eventOnAncestors(e, el) !== true) {
        return
      }
    ...
    __renderPortal (h) {
      return h('transition', {
        ...
        this.showing === true ? h('div', {
          class: 'q-menu__container flex no-pointer-events',
          directives: [{
            name: 'click-outside',
          ...
          h('div', {
            ref: 'inner',
            staticClass: 'q-menu scroll-y all-pointer-events' + this.menuClass,
