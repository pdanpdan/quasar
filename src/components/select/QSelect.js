...
export default Vue.extend({
  ...
  computed: {
    ...
    optionScope () {
      ...
      return this.options.slice(this.virtualListSliceRange.from, this.virtualListSliceRange.to).map((opt, i) => {
  ...
  methods: {
    ...
    setOptionIndex (index) {
      ...
      const val = index > -1 && index < this.virtualListOptionsLength
        ? index
        : -1
    ...
    __onTargetKeydown (e) {
      ...
      // up, down
      const optionsLength = this.virtualListOptionsLength
    ...
    __getDialog (h) {
      ...
      return h(QDialog, {
        ...
        on: {
          ...
          show: () => {
            this.$refs.target !== document.activeElement && this.hasDialog !== true && this.$refs.target.focus()
          }
        }
      }, [
        h('div', {
