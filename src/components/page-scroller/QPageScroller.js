...
import { getScrollTarget, setScrollPosition, getScrollHeight } from '../../utils/scroll.js'
...
export default Vue.extend({
  ...
  methods: {
    ...
    __getScrollHeightClient () {
      return getScrollHeight(getScrollTarget(this.layout.container === true ? this.$el.parentElement : this.layout.$el)) - this.height
    },
