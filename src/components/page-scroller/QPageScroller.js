...
export default Vue.extend({
  ...
  methods: {
    ...
    __getScrollHeight () {
      return (this.layout.container === true ? this.layout.height : 0) - this.height
    },

    __getScrollHeightClient () {
      return (this.layout.container === true ? this.layout.height : document.documentElement.scrollHeight) - this.height
    },
