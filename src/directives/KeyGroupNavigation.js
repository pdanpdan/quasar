...
keyCodes.horizontal.list = Object.values(keyCodes.horizontal).reduce((acc, v) => acc.concat(v), [])
keyCodes.vertical.list = Object.values(keyCodes.vertical).reduce((acc, v) => acc.concat(v), [])
keyCodes.all.list = Object.values(keyCodes.all).reduce((acc, v) => acc.concat(v), [])
