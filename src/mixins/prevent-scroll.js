    ...
    if (client.is.mobile === true) {
      if (visualViewport !== void 0) {
        if (client.is.ios === true) {
          ...
          visualViewport.addEventListener('resize', onViewportResize, passiveCapture)
        }
      }
    ...
    if (client.is.mobile === true) {
      if (visualViewport !== void 0) {
        if (client.is.ios === true) {
          ...
          visualViewport.removeEventListener('resize', onViewportResize, passiveCapture)
        }
      }
