  ...
  orientationTimer = setTimeout(() => {
    requestAnimationFrame(() => {
      if (restorePos.innerWidth !== window.innerWidth) {
        restorePos.scrollLeft = restorePos.scrollLeft < 0
          ? Math.min(0, restorePos.scrollLeft - Math.round((window.innerWidth - restorePos.innerWidth) / 2))
          : Math.max(0, restorePos.scrollLeft + Math.round((window.innerWidth - restorePos.innerWidth) / 2))
