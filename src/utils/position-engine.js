...
// cfg: { el, anchorEl, anchorOrigin, selfOrigin, offset, absoluteOffset, cover, fit, maxHeight, maxWidth, rtl }
export function setPosition (cfg) {
  ...
  intEl.style.flexShrink = 0
  const targetProps = getTargetProps(intEl)
  intEl.style.flexShrink = 1
