...
<html>
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/gh/pdanpdan/quasar@quasar-pdan-<version>/dist/quasar.rtl.min.css" rel="stylesheet" type="text/css">
  </head>
  ...
  <body>
    ...
    <!--
      ...
      Replace "1.0.0" (below) with your Quasar version.
    -->
    <script src="https://cdn.jsdelivr.net/gh/pdanpdan/quasar@quasar-pdan-<version>/dist/lang/he.umd.min.js"></script>
    <script>
