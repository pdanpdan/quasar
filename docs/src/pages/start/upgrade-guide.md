...
10) Finally, become a [backer/sponsor for Dan Popescu](https://github.com/sponsors/pdanpdan) and/or [backer/sponsor for Quasar](https://donate.quasar.dev) (If you donate for Quasar you get access to the special Discord support chat room for priority support).
