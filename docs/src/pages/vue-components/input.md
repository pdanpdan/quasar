...
There are **helpers** for QInput `mask` prop: [full list](https://github.com/pdanpdan/quasar/blob/dev-pdan/ui/src/mixins/mask.js#L2). You can use these for convenience (examples: "phone", "card") or write the string specifying your custom needs.
...
There are **helpers** for QInput `rules` prop: [full list](https://github.com/pdanpdan/quasar/blob/dev-pdan/ui/src/utils/patterns.js). You can use these for convenience (examples: "date", "time", "hexColor", "rgbOrRgbaColor", "anyColor") or write the string specifying your custom needs.
